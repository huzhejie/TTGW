...
namespace TTG.Web.TTGWeb.community_sanitation_problem_finished
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_added_ashbin_num.Text=model.community_added_ashbin_num.ToString();
		this.txtcommunity_added_dustbin_num.Text=model.community_added_dustbin_num.ToString();
		this.txtcommunity_public_toilet_num.Text=model.community_public_toilet_num.ToString();
		this.txtcommunity_public_toilet_area.Text=model.community_public_toilet_area.ToString();
		this.txtcommunity_added_waste_transfer_station_num.Text=model.community_added_waste_transfer_station_num.ToString();
		this.txtcommunity_added_waste_transfer_station_area.Text=model.community_added_waste_transfer_station_area.ToString();
		this.txtcommunity_added_ashbin_dustbin_num.Text=model.community_added_ashbin_dustbin_num.ToString();
		...
		this.txtcommunity_public_toilet_num_f_update.Text=model.community_public_toilet_num_f_update.ToString();
		this.txtcommunity_public_toilet_area_f_update.Text=model.community_public_toilet_area_f_update.ToString();

<%@ Page Title="T_community_cultrue_sports_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_cultrue_sports_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_otd_exercise_yard_area" HeaderText="community_otd_exercise_yard_area" SortExpression="community_otd_exercise_yard_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_fitness_equipment_num" HeaderText="community_added_fitness_equipment_num" SortExpression="community_added_fitness_equipment_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_ind_exercise_yard_area" HeaderText="community_ind_exercise_yard_area" SortExpression="community_ind_exercise_yard_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_ind_exercise_yard_faci_num" HeaderText="community_added_ind_exercise_yard_faci_num" SortExpression="community_added_ind_exercise_yard_faci_num" ItemStyle-HorizontalAlign="Center"  /> 

...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_education dal=new TTG.DAL.TTGWeb.community_education();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_education GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_educationModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_education)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_education> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_education> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_education> modelList = new List<TTG.Model.TTGWeb.community_education>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_education model;

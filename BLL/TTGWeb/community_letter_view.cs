...
{
	/// <summary>
	/// community_letter_view
	/// </summary>
	public partial class community_letter_view
	{
		private readonly TTG.DAL.TTGWeb.community_letter_view dal=new TTG.DAL.TTGWeb.community_letter_view();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_letter_view GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_letter_viewModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_letter_view)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_letter_view> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_letter_view> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_letter_view> modelList = new List<TTG.Model.TTGWeb.community_letter_view>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_letter_view model;

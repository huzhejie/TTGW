...
namespace TTG.Web.TTGWeb.community_building
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_building_total_gfa.Text=model.community_building_total_gfa.ToString();
		this.txtcommunity_building_total_fs.Text=model.community_building_total_fs.ToString();
		this.txtcommunity_building_total_num.Text=model.community_building_total_num.ToString();
		this.txtcommunity_house_gfa.Text=model.community_house_gfa.ToString();
		this.txtcommunity_house_fs.Text=model.community_house_fs.ToString();
		this.txtcommunity_house_num.Text=model.community_house_num.ToString();
		...
		this.txtcommunity_edu_num.Text=model.community_edu_num.ToString();
		this.txtcommunity_medical_gfa.Text=model.community_medical_gfa.ToString();
		this.txtcommunity_medical_fs.Text=model.community_medical_fs.ToString();
		this.txtcommunity_medical_num.Text=model.community_medical_num.ToString();
		...
		this.txtcommunity_culture_sports_num.Text=model.community_culture_sports_num.ToString();
		this.txtcommunity_service_gfa.Text=model.community_service_gfa.ToString();
		this.txtcommunity_service_fs.Text=model.community_service_fs.ToString();
		this.txtcommunity_service_num.Text=model.community_service_num.ToString();
		this.txtcommunity_other_building_gfa.Text=model.community_other_building_gfa.ToString();
		this.txtcommunity_other_building_fs.Text=model.community_other_building_fs.ToString();
		this.txtcommunity_other_building_num.Text=model.community_other_building_num.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttcbunset1.Text=model.tcbunset1;
		this.txttcbunset2.Text=model.tcbunset2;
		this.txttcbunset3.Text=model.tcbunset3;
		this.txttcbunset4.Text=model.tcbunset4;
		this.txttcbunset5.Text=model.tcbunset5;
		this.txttcbunset6.Text=model.tcbunset6;
		this.txttcbunset7.Text=model.tcbunset7;
		this.txttcbunset8.Text=model.tcbunset8;
		this.txttcbunset9.Text=model.tcbunset9;
		this.txttcbunset10.Text=model.tcbunset10;
		this.txttcbunset11.Text=model.tcbunset11;
		this.txttcbunset12.Text=model.tcbunset12;
		this.txttcbunset13.Text=model.tcbunset13;
		this.txttcbunset14.Text=model.tcbunset14;
		this.txttcbunset15.Text=model.tcbunset15;
		this.txttcbunset16.Text=model.tcbunset16;
		this.txttcbunset17.Text=model.tcbunset17;
		this.txttcbunset18.Text=model.tcbunset18;
		this.txttcbunset19.Text=model.tcbunset19;
		this.txttcbunset20.Text=model.tcbunset20;
		this.txttcbunset21.Text=model.tcbunset21;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StantardExcel.aspx.cs"
    Inherits="TTG.Web.StantardExcel" %>
    ...
    <form id="form1" runat="server" action="upload.aspx">
        ...
        <div class="section">
            ...
            <div>
                ...
                <input class="mybtn" id="saveFile" onclick="SaveDoc()" type="button" value="提交"
                    name="CreateFile2" />
            </div>
            ...
            <div class="officeContainer">
                ...
                <div class="officeAlert">
                    <p>
                        如果无法显示excel，请先下载下列内容，安装后重启浏览器
                    </p>
                    <p>
                        兼容火狐或者谷歌浏览器插件，这个是要先安装的。安装后请重启浏览器<a href="WebOffice安装/ffactivex-setup-r39.exe">点击下载</a>
                    </p>
                    <p>
                        webOffice,确保安装兼容插件后请下载安装此控件，安装后记得重启浏览器哦<a href="WebOffice安装/WebOffice.exe">点击下载</a>
                    </p>
                    <p>
                        温馨提示：如果下载安装后依然不能显示，请先确定你的电脑上是否安装了MicrosoftOffice， 如果已经安装可以尝试使用其他浏览器，推荐使用火狐、360或者IE
                    </p>
                </div>
            </div>
        </div>
...
<script type="text/javascript" language="javascript">
    ...
    function SaveDoc() {
        ...
        var returnValue = webObj.HttpPost("http://localhost:8878/upload.aspx?comID=" + comId + "&inID=" + inid + "&state=0");
        if (returnValue == "") {
            alert("文件上传失败");
            return false;
        } else {

<%@ Page Title="T_community_council_building_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_council_building_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_slight_deform_split_num" HeaderText="community_slight_deform_split_num" SortExpression="community_slight_deform_split_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_slight_deform_split_area" HeaderText="community_slight_deform_split_area" SortExpression="community_slight_deform_split_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_house_foun_setm_num" HeaderText="community_house_foun_setm_num" SortExpression="community_house_foun_setm_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_house_foun_setm_area" HeaderText="community_house_foun_setm_area" SortExpression="community_house_foun_setm_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_is_decrepit_house_num" HeaderText="community_is_decrepit_house_num" SortExpression="community_is_decrepit_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_is_decrepit_house_area" HeaderText="community_is_decrepit_house_area" SortExpression="community_is_decrepit_house_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_roof_seepage_house_num" HeaderText="community_roof_seepage_house_num" SortExpression="community_roof_seepage_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_roof_seepage_house_area" HeaderText="community_roof_seepage_house_area" SortExpression="community_roof_seepage_house_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_exw_ct_shedding_house_num" HeaderText="community_exw_ct_shedding_house_num" SortExpression="community_exw_ct_shedding_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_exw_ct_shedding_house_area" HeaderText="community_exw_ct_shedding_house_area" SortExpression="community_exw_ct_shedding_house_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_slope_not_govern_house_num" HeaderText="community_slope_not_govern_house_num" SortExpression="community_slope_not_govern_house_num" ItemStyle-HorizontalAlign="Center"  /> 

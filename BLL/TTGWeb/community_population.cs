...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_population dal=new TTG.DAL.TTGWeb.community_population();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_population GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_populationModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_population)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_population> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_population> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_population> modelList = new List<TTG.Model.TTGWeb.community_population>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_population model;

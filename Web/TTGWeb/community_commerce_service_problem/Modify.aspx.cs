...
namespace TTG.Web.TTGWeb.community_commerce_service_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.txtcommunity_shopping_inc_unit_num.Text=model.community_shopping_inc_unit_num.ToString();
		this.txtcommunity_shopping_inc_people_num.Text=model.community_shopping_inc_people_num.ToString();
		this.txtcommunity_fm_insuf_area_unit_num.Text=model.community_fm_insuf_area_unit_num.ToString();
		this.txtcommunity_fm_insuf_area_people_num.Text=model.community_fm_insuf_area_people_num.ToString();

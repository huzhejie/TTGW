...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.effect_indicator dal=new TTG.DAL.TTGWeb.effect_indicator();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.effect_indicator GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "effect_indicatorModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.effect_indicator)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.effect_indicator> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.effect_indicator> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.effect_indicator> modelList = new List<TTG.Model.TTGWeb.effect_indicator>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.effect_indicator model;

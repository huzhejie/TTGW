...
namespace TTG.Web.TTGWeb.community_water_drain_problem_finished
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.lblcommunity_added_water_drain_pipe_len.Text=model.community_added_water_drain_pipe_len.ToString();
		this.lblcommunity_maintain_ref_water_drain_pipe_len.Text=model.community_maintain_ref_water_drain_pipe_len.ToString();
		this.lblcommunity_septic_tank_num.Text=model.community_septic_tank_num.ToString();
		this.lblcommunity_maintain_ref_septic_tank_num.Text=model.community_maintain_ref_septic_tank_num.ToString();
		this.lblcommunity_maintain_ref_gutter_len.Text=model.community_maintain_ref_gutter_len.ToString();
		this.lblcommunity_added_gutter_len.Text=model.community_added_gutter_len.ToString();
		this.lblcommunity_added_drain_pipe_level.Text=model.community_added_drain_pipe_level;
		this.lblcommunity_added_drain_pipe_len.Text=model.community_added_drain_pipe_len.ToString();
		...
		this.lblcommunity_added_gutter_len_f_update.Text=model.community_added_gutter_len_f_update.ToString();

...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_road dal=new TTG.DAL.TTGWeb.community_road();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_road GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_roadModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_road)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_road> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_road> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_road> modelList = new List<TTG.Model.TTGWeb.community_road>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_road model;

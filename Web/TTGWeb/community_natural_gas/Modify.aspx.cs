...
namespace TTG.Web.TTGWeb.community_natural_gas
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_gas_regulating_station_num.Text=model.community_gas_regulating_station_num.ToString();
		this.txtcommunity_natural_gas_pipe_length.Text=model.community_natural_gas_pipe_length.ToString();
		this.txtlow_pressure_natural_gas_pipe_length.Text=model.low_pressure_natural_gas_pipe_length.ToString();
		this.txtmiddle_pressuse_natural_gas_pipe_length.Text=model.middle_pressuse_natural_gas_pipe_length.ToString();
		this.txtintermediate_pressure_natural_gas_pipe_length.Text=model.intermediate_pressure_natural_gas_pipe_length.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttcngunset1.Text=model.tcngunset1;
		this.txttcngunset2.Text=model.tcngunset2;
		this.txttcngunset3.Text=model.tcngunset3;
		this.txttcngunset4.Text=model.tcngunset4;
		this.txttcngunset5.Text=model.tcngunset5;

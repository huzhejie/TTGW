...
namespace TTG.Web.TTGWeb.community_ff_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.txtcommunity_road_lack_outdoor_fh_num.Text=model.community_road_lack_outdoor_fh_num.ToString();
		this.txtcommunity_road_lack_outdoor_fh_length.Text=model.community_road_lack_outdoor_fh_length.ToString();
		this.txtcommunity_lack_indoor_fh_building_num.Text=model.community_lack_indoor_fh_building_num.ToString();
		this.txtcommunity_lack_fe_building_num.Text=model.community_lack_fe_building_num.ToString();
		this.txtcommunity_fp_damage_num.Text=model.community_fp_damage_num.ToString();
		this.txtcommunity_fp_damage_length.Text=model.community_fp_damage_length.ToString();
		this.txtcommunity_fr_less_4_4_building.Text=model.community_fr_less_4_4_building.ToString();
		this.txtcommunity_mer_wout_12_12_by_building_num.Text=model.community_mer_wout_12_12_by_building_num.ToString();
		this.txtcommunity_oo_beside_fr_building.Text=model.community_oo_beside_fr_building.ToString();
		this.txtcommunity_outdoor_ff_damage_num.Text=model.community_outdoor_ff_damage_num.ToString();

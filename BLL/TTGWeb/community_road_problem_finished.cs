...
{
	/// <summary>
	/// community_road_problem_finished
	/// </summary>
	public partial class community_road_problem_finished
	{
		private readonly TTG.DAL.TTGWeb.community_road_problem_finished dal=new TTG.DAL.TTGWeb.community_road_problem_finished();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_road_problem_finished GetModelByCache(string community_id,DateTime statistics_date,string project_name)
		{
			
			string CacheKey = "community_road_problem_finishedModel-" + community_id+statistics_date+project_name;
			...
			return (TTG.Model.TTGWeb.community_road_problem_finished)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_road_problem_finished> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_road_problem_finished> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_road_problem_finished> modelList = new List<TTG.Model.TTGWeb.community_road_problem_finished>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_road_problem_finished model;

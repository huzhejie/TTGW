...
namespace TTG.Web.TTGWeb.community_business_pop_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.lblcommunity_block_upgrade.Text=model.community_block_upgrade;
		this.lblcommunity_facade_upgrade.Text=model.community_facade_upgrade;
		this.lblcommunity_lack_prof_market.Text=model.community_lack_prof_market;

...
namespace TTG.Web.TTGWeb.sample
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtsample_house_num.Text=model.sample_house_num.ToString();
		this.txtsample_family_pop.Text=model.sample_family_pop.ToString();
		this.txtsample_labor_force_pop.Text=model.sample_labor_force_pop.ToString();
		this.txtsample_employment_lf_pop.Text=model.sample_employment_lf_pop.ToString();
		this.txtsample_primary_industry_lf_pop.Text=model.sample_primary_industry_lf_pop.ToString();
		this.txtsample_secondary_industry_lf_pop.Text=model.sample_secondary_industry_lf_pop.ToString();
		this.txtsample_tertiary_industry_lf_pop.Text=model.sample_tertiary_industry_lf_pop.ToString();
		this.txtsample_PCDI.Text=model.sample_PCDI.ToString();
		this.txtsample_wages_income.Text=model.sample_wages_income.ToString();
		this.txtsample_family_run_pure_income.Text=model.sample_family_run_pure_income.ToString();
		this.txtsample_property_income.Text=model.sample_property_income.ToString();
		this.txtsample_transfer_income.Text=model.sample_transfer_income.ToString();
		this.txtsample_CONSP.Text=model.sample_CONSP.ToString();
		this.txttsunset1.Text=model.tsunset1;
		this.txttsunset2.Text=model.tsunset2;
		this.txttsunset3.Text=model.tsunset3;
		this.txttsunset4.Text=model.tsunset4;
		this.txttsunset5.Text=model.tsunset5;
		this.txttsunset6.Text=model.tsunset6;
		this.txttsunset7.Text=model.tsunset7;
		this.txttsunset8.Text=model.tsunset8;
		this.txttsunset9.Text=model.tsunset9;
		this.txttsunset10.Text=model.tsunset10;
		this.txttsunset11.Text=model.tsunset11;
		this.txttsunset12.Text=model.tsunset12;

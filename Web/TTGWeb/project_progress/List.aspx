<%@ Page Title="T_project_progress" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.project_progress.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="project_id,time" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="project_image_progress" HeaderText="project_image_progress" SortExpression="project_image_progress" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="project_build_stage" HeaderText="project_build_stage" SortExpression="project_build_stage" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="lock_tables" HeaderText="lock_tables" SortExpression="lock_tables" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="project_id,time" DataNavigateUrlFormatString="Show.aspx?id0={0}&id1={1}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="project_id,time" DataNavigateUrlFormatString="Modify.aspx?id0={0}&id1={1}"
                                Text="编辑"  />

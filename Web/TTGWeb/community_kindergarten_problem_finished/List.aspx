<%@ Page Title="T_community_kindergarten_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_kindergarten_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_recon_kindergarten_ins_pop_num" HeaderText="community_recon_kindergarten_ins_pop_num" SortExpression="community_recon_kindergarten_ins_pop_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_kindergarten_ins_class_num" HeaderText="community_recon_kindergarten_ins_class_num" SortExpression="community_recon_kindergarten_ins_class_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_kindergarten_edu_area" HeaderText="community_recon_kindergarten_edu_area" SortExpression="community_recon_kindergarten_edu_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_kindergarten_exercise_yard_area" HeaderText="community_recon_kindergarten_exercise_yard_area" SortExpression="community_recon_kindergarten_exercise_yard_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_kindergarten_ins_pop_num" HeaderText="community_added_kindergarten_ins_pop_num" SortExpression="community_added_kindergarten_ins_pop_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_kindergarten_ins_class_num" HeaderText="community_added_kindergarten_ins_class_num" SortExpression="community_added_kindergarten_ins_class_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_kindergarten_edu_area" HeaderText="community_added_kindergarten_edu_area" SortExpression="community_added_kindergarten_edu_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_kindergarten_exercise_yard_area" HeaderText="community_added_kindergarten_exercise_yard_area" SortExpression="community_added_kindergarten_exercise_yard_area" ItemStyle-HorizontalAlign="Center"  /> 

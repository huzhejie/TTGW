...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.excel_structure dal=new TTG.DAL.TTGWeb.excel_structure();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.excel_structure GetModelByCache(string property,string table_name)
		{
			
			string CacheKey = "excel_structureModel-" + property+table_name;
			...
			return (TTG.Model.TTGWeb.excel_structure)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.excel_structure> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.excel_structure> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.excel_structure> modelList = new List<TTG.Model.TTGWeb.excel_structure>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.excel_structure model;

        ...
        <div class="helpcontent">
            <div class="examineitem fl">
                <div style="float: left">
                    ...
                    <span style="margin-top: 5px; font-size: 20px; font-weight: bold;">已经发布的数据</span>
                </div>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <div style="text-align: right; margin-top: 5px; float: right;">
                            <asp:TextBox ID="TextBoxCom" runat="server" Style="width: 200px; height: 28px; line-height: 28px;"
                                placeholder="请输入小区名"></asp:TextBox>
                            <asp:TextBox ID="TextBoxInves" runat="server" Style="width: 200px; height: 28px;
                                line-height: 28px;" placeholder="请输入调查员"></asp:TextBox>
                            <asp:TextBox ID="TextBoxArea" runat="server" Style="width: 200px; height: 28px; line-height: 28px;"
                                ...
                                <ItemTemplate>
                                    <li>
                                        <div style="float: left; margin-left: 20px;">
                                            <a href="ReadOnlyExcel.aspx?officeFile=<%#Eval("excel_name").ToString()%>" target="_blank">

...
namespace TTG.Web.TTGWeb.community_culture_sports
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_culture_sports_fs.Text=model.community_culture_sports_fs.ToString();
		this.txtcommunity_culture_sports_gfa.Text=model.community_culture_sports_gfa.ToString();
		this.txtcommunity_otd_cul_spo_fac_num.Text=model.community_otd_cul_spo_fac_num.ToString();
		this.txtcommunity_otd_cul_spo_fac_gfa.Text=model.community_otd_cul_spo_fac_gfa.ToString();
		this.txtcommunity_cul_squ_num.Text=model.community_cul_squ_num.ToString();
		this.txtcommunity_cul_squ_fs.Text=model.community_cul_squ_fs.ToString();
		this.txtcommunity_otd_entm_num.Text=model.community_otd_entm_num.ToString();
		this.txtcommunity_otd_entm_fs.Text=model.community_otd_entm_fs.ToString();
		this.txtcommunity_child_plg_num.Text=model.community_child_plg_num.ToString();
		this.txtcommunity_child_plg_fs.Text=model.community_child_plg_fs.ToString();
		this.txtcommunity_ind_actv_spa_num.Text=model.community_ind_actv_spa_num.ToString();
		this.txtcommunity_ind_actv_spa_fs.Text=model.community_ind_actv_spa_fs.ToString();
		this.txtcommunity_ind_actv_spa_gfa.Text=model.community_ind_actv_spa_gfa.ToString();
		this.txtcommunity_cul_sta_num.Text=model.community_cul_sta_num.ToString();
		this.txtcommunity_cul_sta_fs.Text=model.community_cul_sta_fs.ToString();
		this.txtcommunity_cul_sta_gfa.Text=model.community_cul_sta_gfa.ToString();
		this.txtcommunity_cul_room_num.Text=model.community_cul_room_num.ToString();
		this.txtcommunity_cul_room_fs.Text=model.community_cul_room_fs.ToString();
		this.txtcommunity_cul_room_gfa.Text=model.community_cul_room_gfa.ToString();
		this.txtcommunity_fit_fac_num.Text=model.community_fit_fac_num.ToString();
		this.txtcommunity_fit_fac_intact_rate.Text=model.community_fit_fac_intact_rate.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttccsunset1.Text=model.tccsunset1;
		this.txttccsunset2.Text=model.tccsunset2;
		this.txttccsunset3.Text=model.tccsunset3;
		this.txttccsunset4.Text=model.tccsunset4;
		this.txttccsunset5.Text=model.tccsunset5;
		this.txttccsunset6.Text=model.tccsunset6;
		this.txttccsunset7.Text=model.tccsunset7;
		this.txttccsunset8.Text=model.tccsunset8;
		this.txttccsunset9.Text=model.tccsunset9;
		this.txttccsunset10.Text=model.tccsunset10;
		this.txttccsunset11.Text=model.tccsunset11;
		this.txttccsunset12.Text=model.tccsunset12;
		this.txttccsunset13.Text=model.tccsunset13;
		this.txttccsunset14.Text=model.tccsunset14;
		this.txttccsunset15.Text=model.tccsunset15;
		this.txttccsunset16.Text=model.tccsunset16;
		this.txttccsunset17.Text=model.tccsunset17;
		this.txttccsunset18.Text=model.tccsunset18;
		this.txttccsunset19.Text=model.tccsunset19;
		this.txttccsunset20.Text=model.tccsunset20;
		this.txttccsunset21.Text=model.tccsunset21;

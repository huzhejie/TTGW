<%@ Page Title="T_indicator_unit" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.indicator_unit.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="indicator" HeaderText="indicator" SortExpression="indicator" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="translation" HeaderText="translation" SortExpression="translation" ItemStyle-HorizontalAlign="Center"  /> 

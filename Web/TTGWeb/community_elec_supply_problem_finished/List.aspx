<%@ Page Title="T_community_elec_supply_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_elec_supply_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_transformer_capa" HeaderText="community_added_transformer_capa" SortExpression="community_added_transformer_capa" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_maintain_reform_distr_line_len" HeaderText="community_maintain_reform_distr_line_len" SortExpression="community_maintain_reform_distr_line_len" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_ameter_install_hou_num" HeaderText="community_ameter_install_hou_num" SortExpression="community_ameter_install_hou_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_transformer_install_reform_num" HeaderText="community_transformer_install_reform_num" SortExpression="community_transformer_install_reform_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_distr_line_len" HeaderText="community_added_distr_line_len" SortExpression="community_added_distr_line_len" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="community_added_transformer_capa_f_update" HeaderText="community_added_transformer_capa_f_update" SortExpression="community_added_transformer_capa_f_update" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_distr_line_len_f_update" HeaderText="community_added_distr_line_len_f_update" SortExpression="community_added_distr_line_len_f_update" ItemStyle-HorizontalAlign="Center"  /> 

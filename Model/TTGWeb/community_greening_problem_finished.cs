...
{
	/// <summary>
	/// community_greening_problem_finished:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class community_greening_problem_finished
	{
		...
		private int? _community_added_road_resi_green_tree_num;
		private decimal? _community_added_road_resi_green_area;
		private int? _community_govern_green_tree_num;
		private decimal? _community_govern_green_area;
		private int? _community_small_garden_num;
		private decimal? _community_small_garden_area;
		private int? _community_park_num;
		private decimal? _community_park_area;
		...
		/// 
		/// </summary>
		public int? community_added_road_resi_green_tree_num
		{
			set{ _community_added_road_resi_green_tree_num=value;}
			get{return _community_added_road_resi_green_tree_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_added_road_resi_green_area
		{
			set{ _community_added_road_resi_green_area=value;}
			get{return _community_added_road_resi_green_area;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_govern_green_tree_num
		{
			set{ _community_govern_green_tree_num=value;}
			get{return _community_govern_green_tree_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_govern_green_area
		{
			set{ _community_govern_green_area=value;}
			get{return _community_govern_green_area;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_small_garden_num
		{
			set{ _community_small_garden_num=value;}
			get{return _community_small_garden_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_small_garden_area
		{
			set{ _community_small_garden_area=value;}
			get{return _community_small_garden_area;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_park_num
		{
			set{ _community_park_num=value;}
			get{return _community_park_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_park_area
		{
			set{ _community_park_area=value;}
			get{return _community_park_area;}
		}
		/// <summary>
		/// 
		/// </summary>

                    ...
                    <ContentTemplate>
                        ...
                        <%--     <div class="contentleft fl">
                            <ul class="downloadList1">
                                ...
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">湖北省三峡办调研夷移民小区综合帮扶工作 </a></div>
                                    <div class="dow">2015-6-8</div>
                                </li>
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">三峡库区城镇移民小区综合帮扶工作交流会在... </a></div>
                                    <div class="dow">2015-6-7</div>
                                </li>
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">[三峡工委]关注库区重点民生问题 推动移民小区...</a> </div>
                                    <div class="dow">2015-6-6</div>
                                </li>
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">国务院三峡办调研重大项目和小区帮扶项目申报... </a></div>
                                    <div class="dow">2015-6-5</div>
                                </li>
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">国务院三峡办调研“三县”三峡后续工作重大项目... </a></div>
                                    <div class="dow">2015-6-4</div>
                                </li>
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">国务院三峡办调研库区城镇移民帮扶工作</a> </div>
                                    <div class="dow">2015-6-3</div>
                                </li>
                                <li>
                                    <div style="float: left;"><a href="Announce.aspx">湖北省三峡办调研夷移民小区综合帮扶工作 </a></div>
                                    <div class="dow">2015-6-8</div>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="TTG.Web.TTGWeb.community_council_building_problem_finished.Show" Title="显示页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_struc_reinforce_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_struc_reinforce_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_demolished_rebuilt_nu" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_demolished_rebuilt_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_roof_leakproof_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_roof_leakproof_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_facades_maintain_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_facades_maintain_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_slope_govern_house_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_slope_govern_house_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		statistics_date

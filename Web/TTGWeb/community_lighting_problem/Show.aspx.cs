...
namespace TTG.Web.TTGWeb.community_lighting_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.lblcommunity_road_wout_slamp_num.Text=model.community_road_wout_slamp_num.ToString();
		this.lblcommunity_road_wout_slamp_length.Text=model.community_road_wout_slamp_length.ToString();
		this.lblcommunity_road_lack_slamp_insuf_light_num.Text=model.community_road_lack_slamp_insuf_light_num.ToString();
		this.lblcommunity_road_lack_slamp_insuf_light_length.Text=model.community_road_lack_slamp_insuf_light_length.ToString();
		this.lblcommunity_outground_insuf_light_num.Text=model.community_outground_insuf_light_num.ToString();
		this.lblcommunity_corridor_lc_damage_res_num.Text=model.community_corridor_lc_damage_res_num.ToString();
		this.lblcommunity_corridor_light_damage_house_num.Text=model.community_corridor_light_damage_house_num.ToString();
		this.lblcommunity_insuf_light_res_num.Text=model.community_insuf_light_res_num.ToString();
		this.lblcommunity_slamp_damage_num.Text=model.community_slamp_damage_num.ToString();

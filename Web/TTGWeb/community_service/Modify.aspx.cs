...
namespace TTG.Web.TTGWeb.community_service
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_comm_serv_fac_fs.Text=model.community_comm_serv_fac_fs.ToString();
		this.txtcommunity_comm_serv_fac_gfa.Text=model.community_comm_serv_fac_gfa.ToString();
		this.txtcommunity_comm_serv_cen_fs.Text=model.community_comm_serv_cen_fs.ToString();
		this.txtcommunity_comm_serv_cen_gfa.Text=model.community_comm_serv_cen_gfa.ToString();
		this.txtcommunity_comm_serv_cen_dis_ots.Text=model.community_comm_serv_cen_dis_ots.ToString();
		this.txtcommunity_empm_supt_cen_fs.Text=model.community_empm_supt_cen_fs.ToString();
		this.txtcommunity_empm_supt_cen_gfa.Text=model.community_empm_supt_cen_gfa.ToString();
		this.txtcommunity_empm_supt_cen_dis_ots.Text=model.community_empm_supt_cen_dis_ots.ToString();
		this.txtcommunity_police_sta_fs.Text=model.community_police_sta_fs.ToString();
		this.txtcommunity_police_sta_gfa.Text=model.community_police_sta_gfa.ToString();
		this.txtcommunity_police_sta_dis_ots.Text=model.community_police_sta_dis_ots.ToString();
		this.txtcommunity_prop_magm_unit_num.Text=model.community_prop_magm_unit_num.ToString();
		this.txtcommunity_no_prop_magm_unit_num.Text=model.community_no_prop_magm_unit_num.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttcsrunset1.Text=model.tcsrunset1;
		this.txttcsrunset2.Text=model.tcsrunset2;
		this.txttcsrunset3.Text=model.tcsrunset3;
		this.txttcsrunset4.Text=model.tcsrunset4;
		this.txttcsrunset5.Text=model.tcsrunset5;
		this.txttcsrunset6.Text=model.tcsrunset6;
		this.txttcsrunset7.Text=model.tcsrunset7;
		this.txttcsrunset8.Text=model.tcsrunset8;
		this.txttcsrunset9.Text=model.tcsrunset9;
		this.txttcsrunset10.Text=model.tcsrunset10;
		this.txttcsrunset11.Text=model.tcsrunset11;
		this.txttcsrunset12.Text=model.tcsrunset12;
		this.txttcsrunset13.Text=model.tcsrunset13;

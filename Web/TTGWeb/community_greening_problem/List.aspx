<%@ Page Title="T_community_greening_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_greening_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_road_wout_or_few_green_num" HeaderText="community_road_wout_or_few_green_num" SortExpression="community_road_wout_or_few_green_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_road_wout_or_few_green_length" HeaderText="community_road_wout_or_few_green_length" SortExpression="community_road_wout_or_few_green_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_bh_wout_or_few_green_res_num" HeaderText="community_bh_wout_or_few_green_res_num" SortExpression="community_bh_wout_or_few_green_res_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_bh_wout_or_few_green_unit_num" HeaderText="community_bh_wout_or_few_green_unit_num" SortExpression="community_bh_wout_or_few_green_unit_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_green_wout_mta_num" HeaderText="community_green_wout_mta_num" SortExpression="community_green_wout_mta_num" ItemStyle-HorizontalAlign="Center"  /> 

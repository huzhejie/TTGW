                    ...
                    <div id="officecontent">
                        ...
                        <div style="margin-left: 550px;">
                            ...
                            <div style="width: 78%; float: left;">
                                <asp:TextBox ID="filein" runat="server" Style="height: 22px; width: 300px; line-height: 22px;" ReadOnly="true"></asp:TextBox>
                                <input class="mybtn" id="saveFile" onclick="SaveDoc()" type="button" value="提交"
                                    name="CreateFile2"/>
                               <%-- <asp:Button ID="saveButton" runat="server" Text="提交" CssClass="mybtn" 

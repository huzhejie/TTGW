...
namespace TTG.Web.TTGWeb.road
{
	...
	private void ShowInfo(string id,DateTime statistics_date)
	{
		...
		this.txtroad_class.Text=model.road_class;
		this.txtwidth.Text=model.width.ToString();
		this.txtpavement_width.Text=model.pavement_width.ToString();
		this.txtcommunity_road_length.Text=model.community_road_length.ToString();
		this.txtstructure.Text=model.structure;
		this.txtis_dead_end_road.Text=model.is_dead_end_road;
		this.txtdamage_road_length.Text=model.damage_road_length.ToString();
		this.txtlarge_slope_road_length.Text=model.large_slope_road_length.ToString();
		this.txtno_hard_road_length.Text=model.no_hard_road_length.ToString();
		this.txtlack_width_road_length.Text=model.lack_width_road_length.ToString();
		this.txtis_somewhere_no_link.Text=model.is_somewhere_no_link;
		this.txtno_afforest_road_length.Text=model.no_afforest_road_length.ToString();
		this.txtless_afforest_road_length.Text=model.less_afforest_road_length.ToString();
		this.txtstreet_light_amount.Text=model.street_light_amount.ToString();
		this.txtgood_street_light_amount.Text=model.good_street_light_amount.ToString();
		this.txtroad_hydrant_amount.Text=model.road_hydrant_amount.ToString();
		this.txtgood_road_hydrant_amount.Text=model.good_road_hydrant_amount.ToString();
		this.txtroad_dustbin_amount.Text=model.road_dustbin_amount.ToString();
		this.txtgood_road_dustbin_amount.Text=model.good_road_dustbin_amount.ToString();
		this.txtroad_parking_space_num.Text=model.road_parking_space_num.ToString();
		this.txtparking_space_use_rate.Text=model.parking_space_use_rate.ToString();
		...
		this.txttrunset1.Text=model.trunset1;
		this.txttrunset2.Text=model.trunset2;
		this.txttrunset3.Text=model.trunset3;
		this.txttrunset4.Text=model.trunset4;
		this.txttrunset5.Text=model.trunset5;
		this.txttrunset6.Text=model.trunset6;
		this.txttrunset7.Text=model.trunset7;
		this.txttrunset8.Text=model.trunset8;
		this.txttrunset9.Text=model.trunset9;
		this.txttrunset10.Text=model.trunset10;
		this.txttrunset11.Text=model.trunset11;
		this.txttrunset12.Text=model.trunset12;
		this.txttrunset13.Text=model.trunset13;
		this.txttrunset14.Text=model.trunset14;
		this.txttrunset15.Text=model.trunset15;
		this.txttrunset16.Text=model.trunset16;
		this.txttrunset17.Text=model.trunset17;
		this.txttrunset18.Text=model.trunset18;
		this.txttrunset19.Text=model.trunset19;
		this.txttrunset20.Text=model.trunset20;
		this.txttrunset21.Text=model.trunset21;
		this.txttrunset22.Text=model.trunset22;
		this.txttrunset23.Text=model.trunset23;
		this.txttrunset24.Text=model.trunset24;

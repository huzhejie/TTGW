...
{
	/// <summary>
	/// community_water_drain
	/// </summary>
	public partial class community_water_drain
	{
		private readonly TTG.DAL.TTGWeb.community_water_drain dal=new TTG.DAL.TTGWeb.community_water_drain();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_water_drain GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_water_drainModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_water_drain)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_water_drain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_water_drain> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_water_drain> modelList = new List<TTG.Model.TTGWeb.community_water_drain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_water_drain model;

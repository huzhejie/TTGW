...
namespace TTG.Web.TTGWeb.project_classification_content
{
	...
	private void ShowInfo()
	{
		...
		this.txtproject_content.Text=model.project_content;
		this.txtproject_unit.Text=model.project_unit;
		this.txtsubclass.Text=model.subclass;
		this.txtsuperclass.Text=model.superclass;

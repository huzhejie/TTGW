...
namespace TTG.Web
{
    public partial class testStatus : System.Web.UI.Page
    {
        ...
        //{
        //    TTG.DAL.TTGWeb.excel_status gnm = new DAL.TTGWeb.excel_status();
        ...
        //    for (int i = 0; i < folders.Length; i++)
        //    {
        //        string id=folders[i].Substring(0,8);
        //        string name=folders[i].Substring(8,folders[i].Length-8);
        //        string temp = path + folders[i];
        //        ////社区调查表
        //        //DAL.READ.read_wcommunity wcommunity = new DAL.READ.read_wcommunity(path + folders[i] + "\\社区调查表.xls");
        //        //wcommunity.read_and_insert();
        //        ////小区给排水情况表
        //        string[] file={"社区调查表.xls","小区给排水基本情况.xlsx","小区功能定位及人口基本情况.xlsx", "小区供电、照明及绿化基本情况.xlsx",
        //                      "小区管理及监测人员.xlsx","小区交通基本情况.xlsx","小区教育及医疗基本情况.xlsx","小区商贸及社区服务基本情况.xlsx",
        //                      "小区消防、环卫、安防及其他基本情况.xlsx","小区移民门面经营及劳动力就业基本情况.xlsx","小区用地、住房基本情况.xlsx",
        //                      "重要指标年度更新.xlsx","小区效果标准表-填写.xlsx","小区效果标准表续表-填写.xlsx"
        //                      };
        //        for (int k = 0; k < file.Length; k++)
        //        {
        //            gnm.Add(id, name, file[k]);
        //        }
        //        //DAL.READ.read_water_supply water_supply = new DAL.READ.read_water_supply(path + folders[i] + "\\小区给排水基本情况.xlsx");
        //        //water_supply.read_and_insert(ids[i]);
        //        ////小区功能定位及人口基本情况
        ...
        //}
        protected void Page_Load(object sender, EventArgs e) { 
            //TTG.DAL.TTGWeb.image_info dd=new DAL.TTGWeb.image_info();

            //dd.insertSpecial();
            TTG.DAL.TTGWeb.right dd = new DAL.TTGWeb.right();

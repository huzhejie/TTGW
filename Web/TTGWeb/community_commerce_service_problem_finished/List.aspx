<%@ Page Title="T_community_commerce_service_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_commerce_service_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_cvs_area" HeaderText="community_added_cvs_area" SortExpression="community_added_cvs_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_farm_produce_fair_area" HeaderText="community_added_farm_produce_fair_area" SortExpression="community_added_farm_produce_fair_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_farm_produce_fair_area" HeaderText="community_recon_farm_produce_fair_area" SortExpression="community_recon_farm_produce_fair_area" ItemStyle-HorizontalAlign="Center"  /> 

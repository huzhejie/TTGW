...
namespace TTG.Web.TTGWeb.community_water_supply_problem_finished
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		TTG.Model.TTGWeb.community_water_supply_problem_finished model=bll.GetModel(community_id,statistics_date);
		this.lblcommunity_id.Text=model.community_id;
		this.txtcommunity_added_water_supply_capa.Text=model.community_added_water_supply_capa.ToString();
		this.txtcommunity_added_water_supply_pre_facility.Text=model.community_added_water_supply_pre_facility.ToString();
		this.txtcommunity_water_meter_install_hou_num.Text=model.community_water_meter_install_hou_num.ToString();
		this.txtcommunity_maintain_reform_water_pipe_len.Text=model.community_maintain_reform_water_pipe_len.ToString();
		this.txtcommunity_added_water_supply_pipe_len.Text=model.community_added_water_supply_pipe_len.ToString();
		...
		this.txtcommunity_added_water_supply_pipe_len_f_update.Text=model.community_added_water_supply_pipe_len_f_update.ToString();
		this.txtcommunity_added_water_supply_pre_facility_f_update.Text=model.community_added_water_supply_pre_facility_f_update.ToString();
		this.txtcommunity_added_water_supply_capa_f_update.Text=model.community_added_water_supply_capa_f_update.ToString();

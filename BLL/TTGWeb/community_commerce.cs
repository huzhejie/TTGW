...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_commerce dal=new TTG.DAL.TTGWeb.community_commerce();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_commerce GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_commerceModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_commerce)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_commerce> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_commerce> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_commerce> modelList = new List<TTG.Model.TTGWeb.community_commerce>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_commerce model;

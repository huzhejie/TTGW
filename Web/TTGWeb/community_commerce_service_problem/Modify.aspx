<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="TTG.Web.TTGWeb.community_commerce_service_problem.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
	<td height="25" width="30%" align="right">
		community_shopping_inc_unit_num
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcommunity_shopping_inc_unit_num" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		community_shopping_inc_people_num
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcommunity_shopping_inc_people_num" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		community_fm_insuf_area_unit_num
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcommunity_fm_insuf_area_unit_num" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		community_fm_insuf_area_people_num
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcommunity_fm_insuf_area_people_num" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		community_lack_fm

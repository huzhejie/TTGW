...
{
	/// <summary>
	/// community_elec_supply
	/// </summary>
	public partial class community_elec_supply
	{
		private readonly TTG.DAL.TTGWeb.community_elec_supply dal=new TTG.DAL.TTGWeb.community_elec_supply();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_elec_supply GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_elec_supplyModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_elec_supply)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_elec_supply> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_elec_supply> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_elec_supply> modelList = new List<TTG.Model.TTGWeb.community_elec_supply>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_elec_supply model;

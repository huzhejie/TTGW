...
namespace TTG.Web.TTGWeb.community_service_problem
{
	...
	{
		TTG.BLL.TTGWeb.community_service_problem bll=new TTG.BLL.TTGWeb.community_service_problem();
		TTG.Model.TTGWeb.community_service_problem model=bll.GetModel(community_id,community_fill_type,statistics_date);
		this.lblcommunity_id.Text=model.community_id;
		this.lblcommunity_fill_type.Text=model.community_fill_type;
		this.txtcommunity_comp_mana_insuf_house.Text=model.community_comp_mana_insuf_house;
		this.txtcommunity_insuf_pension_faci.Text=model.community_insuf_pension_faci;
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			string strErr="";
			if(this.txtcommunity_comp_mana_insuf_house.Text.Trim().Length==0)
			{
				strErr+="community_comp_mana_insuf_house不能为空！\\n";	
			}
			if(this.txtcommunity_insuf_pension_faci.Text.Trim().Length==0)
			{
				strErr+="community_insuf_pension_faci不能为空！\\n";	
			}
			...
			string community_comp_mana_insuf_house=this.txtcommunity_comp_mana_insuf_house.Text;
			string community_insuf_pension_faci=this.txtcommunity_insuf_pension_faci.Text;
			...
			model.community_comp_mana_insuf_house=community_comp_mana_insuf_house;
			model.community_insuf_pension_faci=community_insuf_pension_faci;

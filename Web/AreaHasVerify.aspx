                ...
                <table>
                    ...
                    <tbody>
                        <asp:Repeater ID="RepeaterAidInf" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td><a href="ReadOnlyExcel.aspx?officeFile=<%#Eval("excel_name").ToString()%>&comId=<%#Eval("community_id").ToString()%>&invesId=<%#Eval("investigator_id").ToString()%>&time=<%#DateTime.Parse(Eval("fill_time").ToString()).ToString("yyyy")%>" target="_blank">
                                        <%#Eval("excel_name").ToString()%>
                                    </a></td>
                                    <td><%#Eval("community_id").ToString()%></td>

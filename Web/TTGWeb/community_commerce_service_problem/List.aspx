<%@ Page Title="T_community_commerce_service_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_commerce_service_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_shopping_inc_unit_num" HeaderText="community_shopping_inc_unit_num" SortExpression="community_shopping_inc_unit_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_shopping_inc_people_num" HeaderText="community_shopping_inc_people_num" SortExpression="community_shopping_inc_people_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_fm_insuf_area_unit_num" HeaderText="community_fm_insuf_area_unit_num" SortExpression="community_fm_insuf_area_unit_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_fm_insuf_area_people_num" HeaderText="community_fm_insuf_area_people_num" SortExpression="community_fm_insuf_area_people_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_lack_fm" HeaderText="community_lack_fm" SortExpression="community_lack_fm" ItemStyle-HorizontalAlign="Center"  /> 

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="TTG.Web.TTGWeb.project_capital.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:label id="lblfurnished_type" runat="server"></asp:label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		total_investment
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txttotal_investment" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		TTG_follow_up_work_approved_special_subsidies
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtTTG_follow_up_work_approved_special_subsidies" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		plan_counterparts_support_funds
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtplan_counterparts_support_funds" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		other_matching_funds
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtother_matching_funds" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		other_funds
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtother_funds" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		time

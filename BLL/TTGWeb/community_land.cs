...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_land dal=new TTG.DAL.TTGWeb.community_land();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_land GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_landModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_land)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_land> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_land> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_land> modelList = new List<TTG.Model.TTGWeb.community_land>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_land model;

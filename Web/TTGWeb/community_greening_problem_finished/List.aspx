<%@ Page Title="T_community_greening_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_greening_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_road_resi_green_tree_num" HeaderText="community_added_road_resi_green_tree_num" SortExpression="community_added_road_resi_green_tree_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_road_resi_green_area" HeaderText="community_added_road_resi_green_area" SortExpression="community_added_road_resi_green_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_govern_green_tree_num" HeaderText="community_govern_green_tree_num" SortExpression="community_govern_green_tree_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_govern_green_area" HeaderText="community_govern_green_area" SortExpression="community_govern_green_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_small_garden_num" HeaderText="community_small_garden_num" SortExpression="community_small_garden_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_small_garden_area" HeaderText="community_small_garden_area" SortExpression="community_small_garden_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_park_num" HeaderText="community_park_num" SortExpression="community_park_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_park_area" HeaderText="community_park_area" SortExpression="community_park_area" ItemStyle-HorizontalAlign="Center"  /> 

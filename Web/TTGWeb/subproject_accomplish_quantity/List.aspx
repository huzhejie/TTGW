<%@ Page Title="T_subproject_accomplish_quantity" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.subproject_accomplish_quantity.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="subproject_finish_quantity" HeaderText="subproject_finish_quantity" SortExpression="subproject_finish_quantity" ItemStyle-HorizontalAlign="Center"  /> 

<%@ Page Title="T_community_water_supply_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_water_supply_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_insuf_ws_res_num" HeaderText="community_insuf_ws_res_num" SortExpression="community_insuf_ws_res_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_ws_house_num" HeaderText="community_insuf_ws_house_num" SortExpression="community_insuf_ws_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_wp_res_num" HeaderText="community_insuf_wp_res_num" SortExpression="community_insuf_wp_res_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_wp_house_num" HeaderText="community_insuf_wp_house_num" SortExpression="community_insuf_wp_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_not_imple_ohot_res_num" HeaderText="community_not_imple_ohot_res_num" SortExpression="community_not_imple_ohot_res_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_not_imple_ohot_house_num" HeaderText="community_not_imple_ohot_house_num" SortExpression="community_not_imple_ohot_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="community_insuf_pipe_size_length" HeaderText="community_insuf_pipe_size_length" SortExpression="community_insuf_pipe_size_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_damage_leakage_pipe_num" HeaderText="community_damage_leakage_pipe_num" SortExpression="community_damage_leakage_pipe_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_damage_leakage_pipe_house_num" HeaderText="community_damage_leakage_pipe_house_num" SortExpression="community_damage_leakage_pipe_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_aging_corrosion_pipe_length" HeaderText="community_aging_corrosion_pipe_length" SortExpression="community_aging_corrosion_pipe_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_aging_corrosion_pipe_house_num" HeaderText="community_aging_corrosion_pipe_house_num" SortExpression="community_aging_corrosion_pipe_house_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_pn_coverage" HeaderText="community_insuf_pn_coverage" SortExpression="community_insuf_pn_coverage" ItemStyle-HorizontalAlign="Center"  /> 

<%@ Page Title="T_community_elec_supply_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_elec_supply_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_transformer_cap_ins_buil_num" HeaderText="community_transformer_cap_ins_buil_num" SortExpression="community_transformer_cap_ins_buil_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_transformer_cap_ins_hou_num" HeaderText="community_transformer_cap_ins_hou_num" SortExpression="community_transformer_cap_ins_hou_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_senescent_elec_wireways_num" HeaderText="community_senescent_elec_wireways_num" SortExpression="community_senescent_elec_wireways_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_senescent_elec_wireways_length" HeaderText="community_senescent_elec_wireways_length" SortExpression="community_senescent_elec_wireways_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_no_one_hou_one_meter_buil_num" HeaderText="community_no_one_hou_one_meter_buil_num" SortExpression="community_no_one_hou_one_meter_buil_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_no_one_hou_one_meter_hou_num" HeaderText="community_no_one_hou_one_meter_hou_num" SortExpression="community_no_one_hou_one_meter_hou_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_unsafe_transformer_num" HeaderText="community_unsafe_transformer_num" SortExpression="community_unsafe_transformer_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_elec_net_insuf" HeaderText="community_elec_net_insuf" SortExpression="community_elec_net_insuf" ItemStyle-HorizontalAlign="Center"  /> 

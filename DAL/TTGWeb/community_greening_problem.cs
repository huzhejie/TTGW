...
{
	/// <summary>
	/// 数据访问类:community_greening_problem
	/// </summary>
	public partial class community_greening_problem
	{
		...
		public bool Exists(string community_id,string community_fill_type,DateTime statistics_date)
		{
			...
			strSql.Append("select count(1) from T_community_greening_problem");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(TTG.Model.TTGWeb.community_greening_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_community_greening_problem(");
			strSql.Append("community_id,community_fill_type,community_road_wout_or_few_green_num,community_bh_wout_or_few_green_res_num,community_green_wout_mta_num,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,tciunset8,lock_tables,complete_year)");
			strSql.Append(" values (");
			strSql.Append("@community_id,@community_fill_type,@community_road_wout_or_few_green_num,@community_bh_wout_or_few_green_res_num,@community_green_wout_mta_num,@statistics_date,@check_status,@tciunset1,@tciunset2,@tciunset3,@tciunset4,@tciunset5,@tciunset6,@tciunset7,@tciunset8,@lock_tables,@complete_year)");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
					new SqlParameter("@community_road_wout_or_few_green_num", SqlDbType.Int,4),
					new SqlParameter("@community_bh_wout_or_few_green_res_num", SqlDbType.Int,4),
					new SqlParameter("@community_green_wout_mta_num", SqlDbType.Int,4),
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
			...
			parameters[2].Value = model.community_road_wout_or_few_green_num;
			parameters[3].Value = model.community_bh_wout_or_few_green_res_num;
			parameters[4].Value = model.community_green_wout_mta_num;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TTG.Model.TTGWeb.community_greening_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_community_greening_problem set ");
			strSql.Append("community_road_wout_or_few_green_num=@community_road_wout_or_few_green_num,");
			strSql.Append("community_bh_wout_or_few_green_res_num=@community_bh_wout_or_few_green_res_num,");
			strSql.Append("community_green_wout_mta_num=@community_green_wout_mta_num,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
					new SqlParameter("@statistics_date", SqlDbType.DateTime)};
			parameters[0].Value = model.community_road_wout_or_few_green_num;
			parameters[1].Value = model.community_bh_wout_or_few_green_res_num;
			parameters[2].Value = model.community_green_wout_mta_num;
			...
			parameters[15].Value = model.community_fill_type;
		...
		public bool Delete(string community_id,string community_fill_type,DateTime statistics_date)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_community_greening_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_greening_problem GetModel(string community_id,string community_fill_type,DateTime statistics_date)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 community_id,community_fill_type,community_road_wout_or_few_green_num,community_bh_wout_or_few_green_res_num,community_green_wout_mta_num,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,tciunset8,lock_tables,complete_year from T_community_greening_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_greening_problem DataRowToModel(DataRow row)
		{
			TTG.Model.TTGWeb.community_greening_problem model=new TTG.Model.TTGWeb.community_greening_problem();
			if (row != null)
			{
				...
				if(row["community_road_wout_or_few_green_num"]!=null && row["community_road_wout_or_few_green_num"].ToString()!="")
				{
					model.community_road_wout_or_few_green_num=int.Parse(row["community_road_wout_or_few_green_num"].ToString());
				}
				if(row["community_bh_wout_or_few_green_res_num"]!=null && row["community_bh_wout_or_few_green_res_num"].ToString()!="")
				{
					model.community_bh_wout_or_few_green_res_num=int.Parse(row["community_bh_wout_or_few_green_res_num"].ToString());
				}
				if(row["community_green_wout_mta_num"]!=null && row["community_green_wout_mta_num"].ToString()!="")
				{
					model.community_green_wout_mta_num=int.Parse(row["community_green_wout_mta_num"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select community_id,community_fill_type,community_road_wout_or_few_green_num,community_bh_wout_or_few_green_res_num,community_green_wout_mta_num,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,tciunset8,lock_tables,complete_year ");
			strSql.Append(" FROM T_community_greening_problem ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_community_greening_problem T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_community_greening_problem";

<%@ Page Title="T_community_kindergarten_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_kindergarten_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_child_not_atts_due_to_insuf_capacity_num" HeaderText="community_child_not_atts_due_to_insuf_capacity_num" SortExpression="community_child_not_atts_due_to_insuf_capacity_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_large_class_num" HeaderText="community_large_class_num" SortExpression="community_large_class_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_required_ta_by_rc" HeaderText="community_required_ta_by_rc" SortExpression="community_required_ta_by_rc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_difference_between_the_actual_ta" HeaderText="community_difference_between_the_actual_ta" SortExpression="community_difference_between_the_actual_ta" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_required_outground_area_by_rc" HeaderText="community_required_outground_area_by_rc" SortExpression="community_required_outground_area_by_rc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_difference_between_the_actual_outground_area" HeaderText="community_difference_between_the_actual_outground_area" SortExpression="community_difference_between_the_actual_outground_area" ItemStyle-HorizontalAlign="Center"  /> 

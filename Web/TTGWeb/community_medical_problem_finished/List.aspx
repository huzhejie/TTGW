<%@ Page Title="T_community_medical_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_medical_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_clinic_num" HeaderText="community_added_clinic_num" SortExpression="community_added_clinic_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_clinic_area" HeaderText="community_added_clinic_area" SortExpression="community_added_clinic_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_clinic_faci_num" HeaderText="community_added_clinic_faci_num" SortExpression="community_added_clinic_faci_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_clinic_num" HeaderText="community_recon_clinic_num" SortExpression="community_recon_clinic_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_clinic_area" HeaderText="community_recon_clinic_area" SortExpression="community_recon_clinic_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_clinic_faci_num" HeaderText="community_recon_clinic_faci_num" SortExpression="community_recon_clinic_faci_num" ItemStyle-HorizontalAlign="Center"  /> 

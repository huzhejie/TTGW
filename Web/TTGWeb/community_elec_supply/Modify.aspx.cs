...
namespace TTG.Web.TTGWeb.community_elec_supply
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_load_dispatching_office_num.Text=model.community_load_dispatching_office_num.ToString();
		this.txtcommunity_transformer_num.Text=model.community_transformer_num.ToString();
		this.txtbelow_100kva_transformer_num.Text=model.below_100kva_transformer_num.ToString();
		this.txtat_100_500kva_transformer_num.Text=model.at_100_500kva_transformer_num.ToString();
		this.txtat_500_1000kva_transformer_num.Text=model.at_500_1000kva_transformer_num.ToString();
		this.txtmore_1000kva_transformer_num.Text=model.more_1000kva_transformer_num.ToString();
		this.txtcommunity_elec_supply_wireways_length.Text=model.community_elec_supply_wireways_length.ToString();
		this.txtcommunity_power_transmission_line_length.Text=model.community_power_transmission_line_length.ToString();
		this.txtcommunity_high_voltage_distr_line_legth.Text=model.community_high_voltage_distr_line_legth.ToString();
		this.txtcommunity_low_voltage_distr_line_legth.Text=model.community_low_voltage_distr_line_legth.ToString();
		this.txtcommunity_elec_supply_consumption.Text=model.community_elec_supply_consumption.ToString();
		this.txtcommunity_resident_elec_consumption.Text=model.community_resident_elec_consumption.ToString();
		this.txtno_elec_days.Text=model.no_elec_days.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttcesunset1.Text=model.tcesunset1;
		this.txttcesunset2.Text=model.tcesunset2;
		this.txttcesunset3.Text=model.tcesunset3;
		this.txttcesunset4.Text=model.tcesunset4;
		this.txttcesunset5.Text=model.tcesunset5;
		this.txttcesunset6.Text=model.tcesunset6;
		this.txttcesunset7.Text=model.tcesunset7;
		this.txttcesunset8.Text=model.tcesunset8;
		this.txttcesunset9.Text=model.tcesunset9;
		this.txttcesunset10.Text=model.tcesunset10;
		this.txttcesunset11.Text=model.tcesunset11;
		this.txttcesunset12.Text=model.tcesunset12;
		this.txttcesunset13.Text=model.tcesunset13;

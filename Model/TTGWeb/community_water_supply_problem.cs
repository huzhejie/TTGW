...
{
	/// <summary>
	/// community_water_supply_problem:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class community_water_supply_problem
	{
		...
		private int? _community_insuf_ws_res_num;
		private int? _community_insuf_ws_house_num;
		private int? _community_insuf_wp_res_num;
		private int? _community_insuf_wp_house_num;
		private int? _community_not_imple_ohot_res_num;
		private int? _community_not_imple_ohot_house_num;
		private int? _community_insuf_pipe_size_num;
		private decimal? _community_insuf_pipe_size_length;
		private int? _community_damage_leakage_pipe_num;
		private int? _community_damage_leakage_pipe_house_num;
		private decimal? _community_aging_corrosion_pipe_length;
		private int? _community_aging_corrosion_pipe_house_num;
		private string _community_insuf_pn_coverage;
		...
		/// 
		/// </summary>
		public int? community_insuf_ws_res_num
		{
			set{ _community_insuf_ws_res_num=value;}
			get{return _community_insuf_ws_res_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_insuf_ws_house_num
		{
			set{ _community_insuf_ws_house_num=value;}
			get{return _community_insuf_ws_house_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_insuf_wp_res_num
		{
			set{ _community_insuf_wp_res_num=value;}
			get{return _community_insuf_wp_res_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_insuf_wp_house_num
		{
			set{ _community_insuf_wp_house_num=value;}
			get{return _community_insuf_wp_house_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_not_imple_ohot_res_num
		{
			set{ _community_not_imple_ohot_res_num=value;}
			get{return _community_not_imple_ohot_res_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_not_imple_ohot_house_num
		{
			set{ _community_not_imple_ohot_house_num=value;}
			get{return _community_not_imple_ohot_house_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public decimal? community_insuf_pipe_size_length
		{
			set{ _community_insuf_pipe_size_length=value;}
			get{return _community_insuf_pipe_size_length;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_damage_leakage_pipe_num
		{
			set{ _community_damage_leakage_pipe_num=value;}
			get{return _community_damage_leakage_pipe_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_damage_leakage_pipe_house_num
		{
			set{ _community_damage_leakage_pipe_house_num=value;}
			get{return _community_damage_leakage_pipe_house_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_aging_corrosion_pipe_length
		{
			set{ _community_aging_corrosion_pipe_length=value;}
			get{return _community_aging_corrosion_pipe_length;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_aging_corrosion_pipe_house_num
		{
			set{ _community_aging_corrosion_pipe_house_num=value;}
			get{return _community_aging_corrosion_pipe_house_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public string community_insuf_pn_coverage
		{
			set{ _community_insuf_pn_coverage=value;}
			get{return _community_insuf_pn_coverage;}
		}
		/// <summary>
		/// 
		/// </summary>

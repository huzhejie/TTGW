...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_culture_sports dal=new TTG.DAL.TTGWeb.community_culture_sports();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_culture_sports GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_culture_sportsModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_culture_sports)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_culture_sports> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_culture_sports> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_culture_sports> modelList = new List<TTG.Model.TTGWeb.community_culture_sports>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_culture_sports model;

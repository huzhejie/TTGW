...
namespace TTG.Web.TTGWeb.community_medical_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.txtcommunity_wout_mp_res_unit.Text=model.community_wout_mp_res_unit.ToString();
		this.txtcommunity_less_mp_res_unit.Text=model.community_less_mp_res_unit.ToString();
		this.txtcommunity_far_domt_res_unit.Text=model.community_far_domt_res_unit.ToString();
		this.txtcommunity_hs_area_shortage_num.Text=model.community_hs_area_shortage_num.ToString();
		this.txtcommunity_hs_faci_imperfect_num.Text=model.community_hs_faci_imperfect_num.ToString();
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			string strErr="";
			if(!PageValidate.IsNumber(txtcommunity_wout_mp_res_unit.Text))
			{
				strErr+="community_wout_mp_res_unit格式错误！\\n";	
			}
			if(!PageValidate.IsNumber(txtcommunity_less_mp_res_unit.Text))
			{
				strErr+="community_less_mp_res_unit格式错误！\\n";	
			}
			if(!PageValidate.IsNumber(txtcommunity_far_domt_res_unit.Text))
			{
				strErr+="community_far_domt_res_unit格式错误！\\n";	
			}
			if(!PageValidate.IsNumber(txtcommunity_hs_area_shortage_num.Text))
			{
				strErr+="community_hs_area_shortage_num格式错误！\\n";	
			}
			if(!PageValidate.IsNumber(txtcommunity_hs_faci_imperfect_num.Text))
			{
				strErr+="community_hs_faci_imperfect_num格式错误！\\n";	
			}
			...
			int community_wout_mp_res_unit=int.Parse(this.txtcommunity_wout_mp_res_unit.Text);
			int community_less_mp_res_unit=int.Parse(this.txtcommunity_less_mp_res_unit.Text);
			int community_far_domt_res_unit=int.Parse(this.txtcommunity_far_domt_res_unit.Text);
			int community_hs_area_shortage_num=int.Parse(this.txtcommunity_hs_area_shortage_num.Text);
			int community_hs_faci_imperfect_num=int.Parse(this.txtcommunity_hs_faci_imperfect_num.Text);
			...
			model.community_wout_mp_res_unit=community_wout_mp_res_unit;
			model.community_less_mp_res_unit=community_less_mp_res_unit;
			model.community_far_domt_res_unit=community_far_domt_res_unit;
			model.community_hs_area_shortage_num=community_hs_area_shortage_num;
			model.community_hs_faci_imperfect_num=community_hs_faci_imperfect_num;

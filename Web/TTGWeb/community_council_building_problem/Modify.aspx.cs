...
namespace TTG.Web.TTGWeb.community_council_building_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.txtcommunity_slight_deform_split_num.Text=model.community_slight_deform_split_num.ToString();
		this.txtcommunity_slight_deform_split_area.Text=model.community_slight_deform_split_area.ToString();
		this.txtcommunity_house_foun_setm_num.Text=model.community_house_foun_setm_num.ToString();
		this.txtcommunity_house_foun_setm_area.Text=model.community_house_foun_setm_area.ToString();
		this.txtcommunity_is_decrepit_house_num.Text=model.community_is_decrepit_house_num.ToString();
		this.txtcommunity_is_decrepit_house_area.Text=model.community_is_decrepit_house_area.ToString();
		this.txtcommunity_roof_seepage_house_num.Text=model.community_roof_seepage_house_num.ToString();
		this.txtcommunity_roof_seepage_house_area.Text=model.community_roof_seepage_house_area.ToString();
		this.txtcommunity_exw_ct_shedding_house_num.Text=model.community_exw_ct_shedding_house_num.ToString();
		this.txtcommunity_exw_ct_shedding_house_area.Text=model.community_exw_ct_shedding_house_area.ToString();
		this.txtcommunity_slope_not_govern_house_num.Text=model.community_slope_not_govern_house_num.ToString();

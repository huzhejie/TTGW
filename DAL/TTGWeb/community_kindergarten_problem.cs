...
{
	/// <summary>
	/// 数据访问类:community_kindergarten_problem
	/// </summary>
	public partial class community_kindergarten_problem
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("complete_year", "T_community_kindergarten_problem"); 
		}
		...
		public bool Exists(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			...
			strSql.Append("select count(1) from T_community_kindergarten_problem");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(TTG.Model.TTGWeb.community_kindergarten_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_community_kindergarten_problem(");
			strSql.Append("community_id,community_fill_type,community_child_not_atts_due_to_insuf_capacity_num,community_large_class_num,statistics_date,check_status,lock_tables,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,tciunset8,tciunset9,community_lack_teaching_area,community_lack_outdoor_playground,complete_year)");
			strSql.Append(" values (");
			strSql.Append("@community_id,@community_fill_type,@community_child_not_atts_due_to_insuf_capacity_num,@community_large_class_num,@statistics_date,@check_status,@lock_tables,@tciunset1,@tciunset2,@tciunset3,@tciunset4,@tciunset5,@tciunset6,@tciunset7,@tciunset8,@tciunset9,@community_lack_teaching_area,@community_lack_outdoor_playground,@complete_year)");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
					new SqlParameter("@community_child_not_atts_due_to_insuf_capacity_num", SqlDbType.Int,4),
					new SqlParameter("@community_large_class_num", SqlDbType.Int,4),
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
					...
					new SqlParameter("@community_lack_teaching_area", SqlDbType.VarChar,50),
					new SqlParameter("@community_lack_outdoor_playground", SqlDbType.VarChar,50),
					new SqlParameter("@complete_year", SqlDbType.Int,4)};
			parameters[0].Value = model.community_id;
			parameters[1].Value = model.community_fill_type;
			parameters[2].Value = model.community_child_not_atts_due_to_insuf_capacity_num;
			parameters[3].Value = model.community_large_class_num;
			parameters[4].Value = model.statistics_date;
			parameters[5].Value = model.check_status;
			parameters[6].Value = model.lock_tables;
			...
			parameters[16].Value = model.community_lack_teaching_area;
			parameters[17].Value = model.community_lack_outdoor_playground;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TTG.Model.TTGWeb.community_kindergarten_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_community_kindergarten_problem set ");
			strSql.Append("community_child_not_atts_due_to_insuf_capacity_num=@community_child_not_atts_due_to_insuf_capacity_num,");
			strSql.Append("community_large_class_num=@community_large_class_num,");
			...
			strSql.Append("community_lack_teaching_area=@community_lack_teaching_area,");
			strSql.Append("community_lack_outdoor_playground=@community_lack_outdoor_playground");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_child_not_atts_due_to_insuf_capacity_num", SqlDbType.Int,4),
					new SqlParameter("@community_large_class_num", SqlDbType.Int,4),
					...
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
					new SqlParameter("@complete_year", SqlDbType.Int,4)};
			parameters[0].Value = model.community_child_not_atts_due_to_insuf_capacity_num;
			parameters[1].Value = model.community_large_class_num;
			parameters[2].Value = model.check_status;
			parameters[3].Value = model.lock_tables;
			...
			parameters[13].Value = model.community_lack_teaching_area;
			parameters[14].Value = model.community_lack_outdoor_playground;
		...
		public bool Delete(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_community_kindergarten_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_kindergarten_problem GetModel(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 community_id,community_fill_type,community_child_not_atts_due_to_insuf_capacity_num,community_large_class_num,statistics_date,check_status,lock_tables,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,tciunset8,tciunset9,community_lack_teaching_area,community_lack_outdoor_playground,complete_year from T_community_kindergarten_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_kindergarten_problem DataRowToModel(DataRow row)
		{
			TTG.Model.TTGWeb.community_kindergarten_problem model=new TTG.Model.TTGWeb.community_kindergarten_problem();
			if (row != null)
			{
				...
				if(row["community_child_not_atts_due_to_insuf_capacity_num"]!=null && row["community_child_not_atts_due_to_insuf_capacity_num"].ToString()!="")
				{
					model.community_child_not_atts_due_to_insuf_capacity_num=int.Parse(row["community_child_not_atts_due_to_insuf_capacity_num"].ToString());
				}
				if(row["community_large_class_num"]!=null && row["community_large_class_num"].ToString()!="")
				{
					model.community_large_class_num=int.Parse(row["community_large_class_num"].ToString());
				}
				...
				if(row["community_lack_teaching_area"]!=null)
				{
					model.community_lack_teaching_area=row["community_lack_teaching_area"].ToString();
				}
				if(row["community_lack_outdoor_playground"]!=null)
				{
					model.community_lack_outdoor_playground=row["community_lack_outdoor_playground"].ToString();
				}
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM T_community_kindergarten_problem ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_community_kindergarten_problem T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_community_kindergarten_problem";

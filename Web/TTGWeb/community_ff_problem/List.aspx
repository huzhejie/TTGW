<%@ Page Title="T_community_ff_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_ff_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_road_lack_outdoor_fh_num" HeaderText="community_road_lack_outdoor_fh_num" SortExpression="community_road_lack_outdoor_fh_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_road_lack_outdoor_fh_length" HeaderText="community_road_lack_outdoor_fh_length" SortExpression="community_road_lack_outdoor_fh_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_lack_indoor_fh_building_num" HeaderText="community_lack_indoor_fh_building_num" SortExpression="community_lack_indoor_fh_building_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_lack_fe_building_num" HeaderText="community_lack_fe_building_num" SortExpression="community_lack_fe_building_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_fp_damage_num" HeaderText="community_fp_damage_num" SortExpression="community_fp_damage_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_fp_damage_length" HeaderText="community_fp_damage_length" SortExpression="community_fp_damage_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_fr_less_4_4_building" HeaderText="community_fr_less_4_4_building" SortExpression="community_fr_less_4_4_building" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_mer_wout_12_12_by_building_num" HeaderText="community_mer_wout_12_12_by_building_num" SortExpression="community_mer_wout_12_12_by_building_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_oo_beside_fr_building" HeaderText="community_oo_beside_fr_building" SortExpression="community_oo_beside_fr_building" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_outdoor_ff_damage_num" HeaderText="community_outdoor_ff_damage_num" SortExpression="community_outdoor_ff_damage_num" ItemStyle-HorizontalAlign="Center"  /> 

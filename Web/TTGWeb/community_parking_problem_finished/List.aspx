<%@ Page Title="T_community_parking_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_parking_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_parking_space_num" HeaderText="community_added_parking_space_num" SortExpression="community_added_parking_space_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_parking_lot_parking_space_num" HeaderText="community_added_parking_lot_parking_space_num" SortExpression="community_added_parking_lot_parking_space_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_parking_lot_area" HeaderText="community_parking_lot_area" SortExpression="community_parking_lot_area" ItemStyle-HorizontalAlign="Center"  /> 

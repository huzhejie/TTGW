<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeeOffice.aspx.cs" Inherits="TTG.Web.SeeOffice" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JS/officemain.js" type="text/javascript"></script>
     <script type="text/javascript" event="NotifyCtrlReady" for="WebOffice1">
...
<body>
    ...
    <div class="m_container">
        ...
        <div id="officecontent">
            ...
            <div class="fl wfdiv" style="margin-top:30px;">

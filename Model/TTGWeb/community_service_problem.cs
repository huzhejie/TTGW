...
{
	/// <summary>
	/// community_service_problem:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class community_service_problem
	{
		...
		private string _community_comp_mana_insuf_house;
		private string _community_insuf_pension_faci;
		...
		/// 
		/// </summary>
		public string community_comp_mana_insuf_house
		{
			set{ _community_comp_mana_insuf_house=value;}
			get{return _community_comp_mana_insuf_house;}
		}
		/// <summary>
		/// 
		/// </summary>
		public string community_insuf_pension_faci
		{
			set{ _community_insuf_pension_faci=value;}
			get{return _community_insuf_pension_faci;}
		}
		/// <summary>
		/// 
		/// </summary>

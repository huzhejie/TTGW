<%@ Page Title="T_community_business_pop_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_business_pop_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_recon_block_len" HeaderText="community_recon_block_len" SortExpression="community_recon_block_len" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_shop_front_num" HeaderText="community_recon_shop_front_num" SortExpression="community_recon_shop_front_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_recon_shop_front_area" HeaderText="community_recon_shop_front_area" SortExpression="community_recon_shop_front_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_market_merchants_num" HeaderText="community_added_market_merchants_num" SortExpression="community_added_market_merchants_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_market_area" HeaderText="community_market_area" SortExpression="community_market_area" ItemStyle-HorizontalAlign="Center"  /> 

...
{
	/// <summary>
	/// 数据访问类:community_parking_problem
	/// </summary>
	public partial class community_parking_problem
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("complete_year", "T_community_parking_problem"); 
		}
		...
		public bool Exists(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			...
			strSql.Append("select count(1) from T_community_parking_problem");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(TTG.Model.TTGWeb.community_parking_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_community_parking_problem(");
			strSql.Append("community_id,community_fill_type,community_insuf_parking_space,community_insuf_parking_lot,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,lock_tables,complete_year)");
			strSql.Append(" values (");
			strSql.Append("@community_id,@community_fill_type,@community_insuf_parking_space,@community_insuf_parking_lot,@statistics_date,@check_status,@tciunset1,@tciunset2,@tciunset3,@tciunset4,@tciunset5,@lock_tables,@complete_year)");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
					new SqlParameter("@community_insuf_parking_space", SqlDbType.VarChar,20),
					new SqlParameter("@community_insuf_parking_lot", SqlDbType.VarChar,20),
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
			...
			parameters[2].Value = model.community_insuf_parking_space;
			parameters[3].Value = model.community_insuf_parking_lot;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TTG.Model.TTGWeb.community_parking_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_community_parking_problem set ");
			strSql.Append("community_insuf_parking_space=@community_insuf_parking_space,");
			strSql.Append("community_insuf_parking_lot=@community_insuf_parking_lot,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
					new SqlParameter("@complete_year", SqlDbType.Int,4)};
			parameters[0].Value = model.community_insuf_parking_space;
			parameters[1].Value = model.community_insuf_parking_lot;
		...
		public bool Delete(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_community_parking_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_parking_problem GetModel(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 community_id,community_fill_type,community_insuf_parking_space,community_insuf_parking_lot,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,lock_tables,complete_year from T_community_parking_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_parking_problem DataRowToModel(DataRow row)
		{
			TTG.Model.TTGWeb.community_parking_problem model=new TTG.Model.TTGWeb.community_parking_problem();
			if (row != null)
			{
				...
				if(row["community_insuf_parking_space"]!=null)
				{
					model.community_insuf_parking_space=row["community_insuf_parking_space"].ToString();
				}
				if(row["community_insuf_parking_lot"]!=null)
				{
					model.community_insuf_parking_lot=row["community_insuf_parking_lot"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select community_id,community_fill_type,community_insuf_parking_space,community_insuf_parking_lot,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,lock_tables,complete_year ");
			strSql.Append(" FROM T_community_parking_problem ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_community_parking_problem T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_community_parking_problem";

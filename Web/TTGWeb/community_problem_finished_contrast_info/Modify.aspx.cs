...
namespace TTG.Web.TTGWeb.community_problem_finished_contrast_info
{
	...
	private void ShowInfo()
	{
		...
		this.txtcommunity_problem_content.Text=model.community_problem_content;
		this.txtcommunity_problem_unit.Text=model.community_problem_unit;
		this.txtcommunity_finish_content.Text=model.community_finish_content;
		this.txtcommunity_finish_content_unit.Text=model.community_finish_content_unit;

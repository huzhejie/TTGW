...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.Community_Indicator dal=new TTG.DAL.TTGWeb.Community_Indicator();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.Community_Indicator GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "Community_IndicatorModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.Community_Indicator)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.Community_Indicator> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.Community_Indicator> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.Community_Indicator> modelList = new List<TTG.Model.TTGWeb.Community_Indicator>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.Community_Indicator model;

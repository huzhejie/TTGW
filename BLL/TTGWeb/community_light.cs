...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_light dal=new TTG.DAL.TTGWeb.community_light();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_light GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_lightModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_light)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_light> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_light> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_light> modelList = new List<TTG.Model.TTGWeb.community_light>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_light model;

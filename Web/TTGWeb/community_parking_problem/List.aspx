<%@ Page Title="T_community_parking_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_parking_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_insuf_parking_space" HeaderText="community_insuf_parking_space" SortExpression="community_insuf_parking_space" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_parking_lot" HeaderText="community_insuf_parking_lot" SortExpression="community_insuf_parking_lot" ItemStyle-HorizontalAlign="Center"  /> 

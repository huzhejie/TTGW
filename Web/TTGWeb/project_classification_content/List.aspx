<%@ Page Title="T_project_classification_content" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.project_classification_content.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="project_content" HeaderText="project_content" SortExpression="project_content" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="project_unit" HeaderText="project_unit" SortExpression="project_unit" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="subclass" HeaderText="subclass" SortExpression="subclass" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="superclass" HeaderText="superclass" SortExpression="superclass" ItemStyle-HorizontalAlign="Center"  /> 

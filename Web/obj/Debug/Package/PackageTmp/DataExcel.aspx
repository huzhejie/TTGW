<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataExcel.aspx.cs" Inherits="TTG.Web.DataExcel" %>
        ...
        <div class="m_header">
            <%--<div class="section">
                    ...
                    <div class="m_hright fl">
                              <div class="title">
                                    <p style="font-size:45px;font-weight:bold;">三峡城镇小区帮扶监测信息平台</p>
                              </div>
                    </div>
             </div>--%>
        </div>
        ...
        <div id="officecontent">
            ...
            <div style="margin-left: 550px;">
                ...
                <div style="width: 78%; float: left;">
                 ...
                 <input class="mybtn" id="CreateFile2" onclick="SaveDoc()" type="button" value="发布" name="CreateFile2"/>
            ...
            <div class="fl wfdiv">
                ...
                <div class="webalert fl" >
                    ...
                    <p>温馨提示：如果下载安装后依然不能显示，请先确定你的电脑上是否安装了MicrosoftOffice，
                    如果已经安装可以尝试使用其他浏览器，推荐使用火狐、360或者IE</p>
...
<script type="text/javascript" language="javascript">
    ...
    <script type="text/javascript">
        ...
        function SaveDoc() {
            ...
            var returnValue = webObj.HttpPost("http://localhost:8878/upload.aspx?comID=" + comId + "&inID=" + inid + "&state=2");
            if (returnValue == "") {
                alert("文件上传失败");
            } else {
                alert("文件上传成功")

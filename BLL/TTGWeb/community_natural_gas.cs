...
{
	/// <summary>
	/// community_natural_gas
	/// </summary>
	public partial class community_natural_gas
	{
		private readonly TTG.DAL.TTGWeb.community_natural_gas dal=new TTG.DAL.TTGWeb.community_natural_gas();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_natural_gas GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_natural_gasModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_natural_gas)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_natural_gas> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_natural_gas> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_natural_gas> modelList = new List<TTG.Model.TTGWeb.community_natural_gas>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_natural_gas model;

...
namespace TTG.Web
{
    public partial class AreaHasVerify : System.Web.UI.Page
    {
        ...
        private void getdata(int start, int end)
        {
            ...
            //计算数据总量得到分页数量
            int recordCount = DEXCEL.GetRecordCount(areaChief_id,investicator_id,comid, 1,2);//=
            AspNetPager1.RecordCount = recordCount;
            AspNetPager1.PageSize = 18;
            DataSet ds = DEXCEL.GetListByPage(areaChief_id, investicator_id, comid, 1,2, start, end);
            //这里添加首次需要加载的24条数据
            //综合帮扶信息数据

...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.Community_Base dal=new TTG.DAL.TTGWeb.Community_Base();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.Community_Base GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "Community_BaseModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.Community_Base)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.Community_Base> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.Community_Base> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.Community_Base> modelList = new List<TTG.Model.TTGWeb.Community_Base>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.Community_Base model;

<%@ Page Title="T_community_business_pop_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_business_pop_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_block_upgrade" HeaderText="community_block_upgrade" SortExpression="community_block_upgrade" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_facade_upgrade" HeaderText="community_facade_upgrade" SortExpression="community_facade_upgrade" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_lack_prof_market" HeaderText="community_lack_prof_market" SortExpression="community_lack_prof_market" ItemStyle-HorizontalAlign="Center"  /> 

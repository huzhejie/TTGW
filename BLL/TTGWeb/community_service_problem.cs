...
{
	/// <summary>
	/// community_service_problem
	/// </summary>
	public partial class community_service_problem
	{
		private readonly TTG.DAL.TTGWeb.community_service_problem dal=new TTG.DAL.TTGWeb.community_service_problem();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_service_problem GetModelByCache(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			
			string CacheKey = "community_service_problemModel-" + community_id+community_fill_type+statistics_date+complete_year;
			...
			return (TTG.Model.TTGWeb.community_service_problem)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_service_problem> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_service_problem> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_service_problem> modelList = new List<TTG.Model.TTGWeb.community_service_problem>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_service_problem model;

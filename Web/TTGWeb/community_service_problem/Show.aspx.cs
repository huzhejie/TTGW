...
namespace TTG.Web.TTGWeb.community_service_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.lblcommunity_comp_mana_insuf_house.Text=model.community_comp_mana_insuf_house;
		this.lblcommunity_insuf_pension_faci.Text=model.community_insuf_pension_faci;

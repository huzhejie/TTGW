...
namespace TTG.Web.TTGWeb.community_water_drain_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.txtcommunity_pipe_no_reasonable_num.Text=model.community_pipe_no_reasonable_num.ToString();
		this.txtcommunity_form_warea_num.Text=model.community_form_warea_num.ToString();
		this.txtcommunity_form_warea_affect_res_num.Text=model.community_form_warea_affect_res_num.ToString();
		this.txtcommunity_not_access_uspn_res_num.Text=model.community_not_access_uspn_res_num.ToString();
		this.txtcommunity_not_access_uspn_house_num.Text=model.community_not_access_uspn_house_num.ToString();
		this.txtcommunity_insuf_pipe_size_num.Text=model.community_insuf_pipe_size_num.ToString();
		this.txtcommunity_pipe_aging_corrosion_num.Text=model.community_pipe_aging_corrosion_num.ToString();
		this.txtcommunity_pipe_damage_num.Text=model.community_pipe_damage_num.ToString();
		this.txtcommunity_septic_small_volume_num.Text=model.community_septic_small_volume_num.ToString();
		this.txtcommunity_septic_damage_leaking_num.Text=model.community_septic_damage_leaking_num.ToString();
		this.txtcommunity_sewage_straight_to_cj_num.Text=model.community_sewage_straight_to_cj_num.ToString();
		this.txtcommunity_gutter_damage.Text=model.community_gutter_damage;
		this.txtcommunity_insuf_gutter.Text=model.community_insuf_gutter;
		...
		this.txtcommunity_pipe_damage_length.Text=model.community_pipe_damage_length.ToString();

...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_medical dal=new TTG.DAL.TTGWeb.community_medical();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_medical GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_medicalModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_medical)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_medical> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_medical> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_medical> modelList = new List<TTG.Model.TTGWeb.community_medical>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_medical model;

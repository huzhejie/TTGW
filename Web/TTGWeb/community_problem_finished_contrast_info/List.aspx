<%@ Page Title="T_community_problem_finished_contrast_info" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_problem_finished_contrast_info.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_problem_content" HeaderText="community_problem_content" SortExpression="community_problem_content" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_problem_unit" HeaderText="community_problem_unit" SortExpression="community_problem_unit" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_finish_content" HeaderText="community_finish_content" SortExpression="community_finish_content" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_finish_content_unit" HeaderText="community_finish_content_unit" SortExpression="community_finish_content_unit" ItemStyle-HorizontalAlign="Center"  /> 

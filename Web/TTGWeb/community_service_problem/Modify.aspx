<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="TTG.Web.TTGWeb.community_service_problem.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
	<td height="25" width="30%" align="right">
		community_comp_mana_insuf_house
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcommunity_comp_mana_insuf_house" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		community_insuf_pension_faci
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcommunity_insuf_pension_faci" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		statistics_date

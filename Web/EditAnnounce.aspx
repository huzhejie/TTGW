...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="editAnno">
        ...
        <div class="mb20">
            ...
            <input id="Texttitle" type="text" class="manageBotInput" style="width: 500px;"
                runat="server" /><br />
            <br />
            <script type="text/plain" id="myEditorU" style="width: 800px; height: 380px;">
                        
            </script>
            <asp:HiddenField ID="mytextu" runat="server" />
        </div>
        <input id="Texthide" type="text" class="dn" runat="server" />
        <div>
            <span>公告类型：</span>
            ...
            <asp:Button ID="modifyBtn" runat="server" Text="修改" CssClass="mybtn manageBtn"

...
namespace TTG.Web.TTGWeb.community_business_pop_problem_finished
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.lblcommunity_recon_block_len.Text=model.community_recon_block_len.ToString();
		this.lblcommunity_recon_shop_front_num.Text=model.community_recon_shop_front_num.ToString();
		this.lblcommunity_recon_shop_front_area.Text=model.community_recon_shop_front_area.ToString();
		this.lblcommunity_added_market_merchants_num.Text=model.community_added_market_merchants_num.ToString();
		this.lblcommunity_market_area.Text=model.community_market_area.ToString();

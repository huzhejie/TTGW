<%@ Page Title="T_community_water_drain_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_water_drain_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_water_drain_pipe_len" HeaderText="community_added_water_drain_pipe_len" SortExpression="community_added_water_drain_pipe_len" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_maintain_ref_water_drain_pipe_len" HeaderText="community_maintain_ref_water_drain_pipe_len" SortExpression="community_maintain_ref_water_drain_pipe_len" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="community_maintain_ref_septic_tank_num" HeaderText="community_maintain_ref_septic_tank_num" SortExpression="community_maintain_ref_septic_tank_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_maintain_ref_gutter_len" HeaderText="community_maintain_ref_gutter_len" SortExpression="community_maintain_ref_gutter_len" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_gutter_len" HeaderText="community_added_gutter_len" SortExpression="community_added_gutter_len" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_drain_pipe_level" HeaderText="community_added_drain_pipe_level" SortExpression="community_added_drain_pipe_level" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_drain_pipe_len" HeaderText="community_added_drain_pipe_len" SortExpression="community_added_drain_pipe_len" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="community_added_gutter_len_f_update" HeaderText="community_added_gutter_len_f_update" SortExpression="community_added_gutter_len_f_update" ItemStyle-HorizontalAlign="Center"  /> 

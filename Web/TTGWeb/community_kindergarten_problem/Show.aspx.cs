...
namespace TTG.Web.TTGWeb.community_kindergarten_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.lblcommunity_child_not_atts_due_to_insuf_capacity_num.Text=model.community_child_not_atts_due_to_insuf_capacity_num.ToString();
		this.lblcommunity_large_class_num.Text=model.community_large_class_num.ToString();
		this.lblcommunity_required_ta_by_rc.Text=model.community_required_ta_by_rc.ToString();
		this.lblcommunity_difference_between_the_actual_ta.Text=model.community_difference_between_the_actual_ta.ToString();
		this.lblcommunity_required_outground_area_by_rc.Text=model.community_required_outground_area_by_rc.ToString();
		this.lblcommunity_difference_between_the_actual_outground_area.Text=model.community_difference_between_the_actual_outground_area.ToString();

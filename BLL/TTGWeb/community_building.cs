...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_building dal=new TTG.DAL.TTGWeb.community_building();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_building GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_buildingModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_building)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_building> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_building> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_building> modelList = new List<TTG.Model.TTGWeb.community_building>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_building model;

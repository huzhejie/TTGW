...
{
	/// <summary>
	/// community_sanitation_problem:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class community_sanitation_problem
	{
		...
		private int? _community_road_lack_rd_num;
		private int? _community_insuf_resd_area;
		private int? _community_along_rs_garbage_pup_num;
		private int? _community_bsa_etc_hc_garbage_pup_num;
		private int? _community_toilet_insuf_pt_area;
		private int? _community_regional_insuf_sf_num;
		...
		/// 
		/// </summary>
		public int? community_road_lack_rd_num
		{
			set{ _community_road_lack_rd_num=value;}
			get{return _community_road_lack_rd_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_insuf_resd_area
		{
			set{ _community_insuf_resd_area=value;}
			get{return _community_insuf_resd_area;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_along_rs_garbage_pup_num
		{
			set{ _community_along_rs_garbage_pup_num=value;}
			get{return _community_along_rs_garbage_pup_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_bsa_etc_hc_garbage_pup_num
		{
			set{ _community_bsa_etc_hc_garbage_pup_num=value;}
			get{return _community_bsa_etc_hc_garbage_pup_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_toilet_insuf_pt_area
		{
			set{ _community_toilet_insuf_pt_area=value;}
			get{return _community_toilet_insuf_pt_area;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_regional_insuf_sf_num
		{
			set{ _community_regional_insuf_sf_num=value;}
			get{return _community_regional_insuf_sf_num;}
		}
		/// <summary>
		/// 
		/// </summary>

<%@ Page Title="T_community_medical_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_medical_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_wout_mp_res_unit" HeaderText="community_wout_mp_res_unit" SortExpression="community_wout_mp_res_unit" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_less_mp_res_unit" HeaderText="community_less_mp_res_unit" SortExpression="community_less_mp_res_unit" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_far_domt_res_unit" HeaderText="community_far_domt_res_unit" SortExpression="community_far_domt_res_unit" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_hs_area_shortage_num" HeaderText="community_hs_area_shortage_num" SortExpression="community_hs_area_shortage_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_hs_faci_imperfect_num" HeaderText="community_hs_faci_imperfect_num" SortExpression="community_hs_faci_imperfect_num" ItemStyle-HorizontalAlign="Center"  /> 

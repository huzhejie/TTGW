...
namespace TTG.Web.TTGWeb.community_medical
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_medical_inst_num.Text=model.community_medical_inst_num.ToString();
		this.txtcommunity_medical_inst_fs.Text=model.community_medical_inst_fs.ToString();
		this.txtcommunity_medical_inst_gfa.Text=model.community_medical_inst_gfa.ToString();
		this.txtcommunity_hospital_num.Text=model.community_hospital_num.ToString();
		this.txtcommunity_hospital_gfa.Text=model.community_hospital_gfa.ToString();
		this.txtcommunity_hospital_fs.Text=model.community_hospital_fs.ToString();
		this.txtcommunity_hospital_bed_num.Text=model.community_hospital_bed_num.ToString();
		this.txtcommunity_hospital_dis_ots.Text=model.community_hospital_dis_ots.ToString();
		this.txtcommunity_heal_sta_num.Text=model.community_heal_sta_num.ToString();
		this.txtcommunity_heal_sta_fs.Text=model.community_heal_sta_fs.ToString();
		this.txtcommunity_heal_sta_gfa.Text=model.community_heal_sta_gfa.ToString();
		this.txtcommunity_heal_sta_bed_num.Text=model.community_heal_sta_bed_num.ToString();
		this.txtcommunity_heal_sta_dis_ots.Text=model.community_heal_sta_dis_ots.ToString();
		this.txtcommunity_clinic_num.Text=model.community_clinic_num.ToString();
		this.txtcommunity_clinic_fs.Text=model.community_clinic_fs.ToString();
		this.txtcommunity_clinic_gfa.Text=model.community_clinic_gfa.ToString();
		this.txtcommunity_clinic_bed_num.Text=model.community_clinic_bed_num.ToString();
		this.txtcommunity_clinic_dis_ots.Text=model.community_clinic_dis_ots.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttcmunset1.Text=model.tcmunset1;
		this.txttcmunset2.Text=model.tcmunset2;
		this.txttcmunset3.Text=model.tcmunset3;
		this.txttcmunset4.Text=model.tcmunset4;
		this.txttcmunset5.Text=model.tcmunset5;
		this.txttcmunset6.Text=model.tcmunset6;
		this.txttcmunset7.Text=model.tcmunset7;
		this.txttcmunset8.Text=model.tcmunset8;
		this.txttcmunset9.Text=model.tcmunset9;
		this.txttcmunset10.Text=model.tcmunset10;
		this.txttcmunset11.Text=model.tcmunset11;
		this.txttcmunset12.Text=model.tcmunset12;
		this.txttcmunset13.Text=model.tcmunset13;
		this.txttcmunset14.Text=model.tcmunset14;
		this.txttcmunset15.Text=model.tcmunset15;
		this.txttcmunset16.Text=model.tcmunset16;
		this.txttcmunset17.Text=model.tcmunset17;
		this.txttcmunset18.Text=model.tcmunset18;

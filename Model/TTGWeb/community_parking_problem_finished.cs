...
{
	/// <summary>
	/// community_parking_problem_finished:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class community_parking_problem_finished
	{
		...
		private int? _community_added_parking_space_num;
		private int? _community_added_parking_lot_parking_space_num;
		private decimal? _community_parking_lot_area;
		...
		/// 
		/// </summary>
		public int? community_added_parking_space_num
		{
			set{ _community_added_parking_space_num=value;}
			get{return _community_added_parking_space_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? community_added_parking_lot_parking_space_num
		{
			set{ _community_added_parking_lot_parking_space_num=value;}
			get{return _community_added_parking_lot_parking_space_num;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_parking_lot_area
		{
			set{ _community_parking_lot_area=value;}
			get{return _community_parking_lot_area;}
		}
		/// <summary>
		/// 
		/// </summary>

...
{
	/// <summary>
	/// community_service_problem_finished:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class community_service_problem_finished
	{
		...
		private decimal? _community_added_integrated_manage_house_area;
		private decimal? _community_added_pension_faci_area;
		...
		/// 
		/// </summary>
		public decimal? community_added_integrated_manage_house_area
		{
			set{ _community_added_integrated_manage_house_area=value;}
			get{return _community_added_integrated_manage_house_area;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? community_added_pension_faci_area
		{
			set{ _community_added_pension_faci_area=value;}
			get{return _community_added_pension_faci_area;}
		}
		/// <summary>
		/// 
		/// </summary>

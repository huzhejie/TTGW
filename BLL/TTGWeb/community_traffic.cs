...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_traffic dal=new TTG.DAL.TTGWeb.community_traffic();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_traffic GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_trafficModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_traffic)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_traffic> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_traffic> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_traffic> modelList = new List<TTG.Model.TTGWeb.community_traffic>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_traffic model;

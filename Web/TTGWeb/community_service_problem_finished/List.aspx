<%@ Page Title="T_community_service_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_service_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_integrated_manage_house_area" HeaderText="community_added_integrated_manage_house_area" SortExpression="community_added_integrated_manage_house_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_pension_faci_area" HeaderText="community_added_pension_faci_area" SortExpression="community_added_pension_faci_area" ItemStyle-HorizontalAlign="Center"  /> 

<%@ Page Title="T_community_bet_dwellings_road_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_bet_dwellings_road_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_hroad_pavement_damage_area" HeaderText="community_hroad_pavement_damage_area" SortExpression="community_hroad_pavement_damage_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_hroad_not_hardening_area" HeaderText="community_hroad_not_hardening_area" SortExpression="community_hroad_not_hardening_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_some_runit_lack_lroad_num" HeaderText="community_some_runit_lack_lroad_num" SortExpression="community_some_runit_lack_lroad_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_psw_damage_length" HeaderText="community_psw_damage_length" SortExpression="community_psw_damage_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_psw_fence_damage_length" HeaderText="community_psw_fence_damage_length" SortExpression="community_psw_fence_damage_length" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_some_rc_lack_lroad" HeaderText="community_some_rc_lack_lroad" SortExpression="community_some_rc_lack_lroad" ItemStyle-HorizontalAlign="Center"  /> 

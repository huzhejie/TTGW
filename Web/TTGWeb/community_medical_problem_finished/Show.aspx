<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="TTG.Web.TTGWeb.community_medical_problem_finished.Show" Title="显示页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_added_clinic_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_added_clinic_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_added_clinic_faci_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_recon_clinic_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_recon_clinic_area" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblcommunity_recon_clinic_faci_num" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		statistics_date

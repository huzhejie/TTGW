...
namespace TTG.Web.TTGWeb.community_project
{
	...
	private void ShowInfo(string county_name,string project_id,DateTime statistics_date)
	{
		...
		this.txtproject_category.Text=model.project_category;
		this.txtproject_add_time.Text=model.project_add_time.ToString();
		this.txtproject_total_investment.Text=model.project_total_investment.ToString();
		this.txtproject_proprietor.Text=model.project_proprietor;
		this.txtplan_to_bulid.Text=model.plan_to_bulid;
		this.txtbiding_finish_time.Text=model.biding_finish_time.ToString();
		this.txtcontract_period.Text=model.contract_period;
		this.txtproject_start_time.Text=model.project_start_time.ToString();
		this.txtnot_started_reason_analysis.Text=model.not_started_reason_analysis;
		this.txtcomplete_time.Text=model.complete_time.ToString();
		this.txtproject_delay_reason_analysis.Text=model.project_delay_reason_analysis;
		this.txtif_major_quality_or_security_accident_happened.Text=model.if_major_quality_or_security_accident_happened;
		this.txtproject_complete_acceptance_time.Text=model.project_complete_acceptance_time.ToString();
		this.txtcomplete_acceptance_quality_level.Text=model.complete_acceptance_quality_level;
		this.txtif_transfer.Text=model.if_transfer;
		this.txtproject_community_correlation_description.Text=model.project_community_correlation_description;
		this.txtnote_information.Text=model.note_information;
		this.txtproject_type.Text=model.project_type;
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txtmajor_quality_or_security_accident.Text=model.major_quality_or_security_accident;
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			string county_name=this.lblcounty_name.Text;

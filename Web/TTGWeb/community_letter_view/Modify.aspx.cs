...
namespace TTG.Web.TTGWeb.community_letter_view
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_lv_num.Text=model.community_lv_num.ToString();
		this.txtcommunity_lv_pop.Text=model.community_lv_pop.ToString();
		this.txtcommunity_lv_county_government_num.Text=model.community_lv_county_government_num.ToString();
		this.txtcommunity_lv_county_government_pop.Text=model.community_lv_county_government_pop.ToString();
		this.txtcommunity_lv_county_industry_num.Text=model.community_lv_county_industry_num.ToString();
		this.txtcommunity_lv_county_industry_pop.Text=model.community_lv_county_industry_pop.ToString();
		this.txtcommunity_lv_street_agency_num.Text=model.community_lv_street_agency_num.ToString();
		this.txtcommunity_lv_street_agency_pop.Text=model.community_lv_street_agency_pop.ToString();
		this.txtcommunity_lv_neighborhood_committee_num.Text=model.community_lv_neighborhood_committee_num.ToString();
		this.txtcommunity_lv_neighborhood_committee_pop.Text=model.community_lv_neighborhood_committee_pop.ToString();
		this.txtcommunity_lv_immigration_num.Text=model.community_lv_immigration_num.ToString();
		this.txtcommunity_lv_basic_fac_num.Text=model.community_lv_basic_fac_num.ToString();
		this.txtcommunity_lv_service_fac_num.Text=model.community_lv_service_fac_num.ToString();
		this.txtcommunity_lv_livelihood_difficulty_num.Text=model.community_lv_livelihood_difficulty_num.ToString();
		this.txtcommunity_lv_disputes_complaints_num.Text=model.community_lv_disputes_complaints_num.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttclvunset1.Text=model.tclvunset1;
		this.txttclvunset2.Text=model.tclvunset2;
		this.txttclvunset3.Text=model.tclvunset3;
		this.txttclvunset4.Text=model.tclvunset4;
		this.txttclvunset5.Text=model.tclvunset5;
		this.txttclvunset6.Text=model.tclvunset6;
		this.txttclvunset7.Text=model.tclvunset7;
		this.txttclvunset8.Text=model.tclvunset8;
		this.txttclvunset9.Text=model.tclvunset9;
		this.txttclvunset10.Text=model.tclvunset10;
		this.txttclvunset11.Text=model.tclvunset11;
		this.txttclvunset12.Text=model.tclvunset12;
		this.txttclvunset13.Text=model.tclvunset13;
		this.txttclvunset14.Text=model.tclvunset14;
		this.txttclvunset15.Text=model.tclvunset15;

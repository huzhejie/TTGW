...
{
	/// <summary>
	/// community_parking_lot
	/// </summary>
	public partial class community_parking_lot
	{
		private readonly TTG.DAL.TTGWeb.community_parking_lot dal=new TTG.DAL.TTGWeb.community_parking_lot();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_parking_lot GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_parking_lotModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_parking_lot)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_parking_lot> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_parking_lot> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_parking_lot> modelList = new List<TTG.Model.TTGWeb.community_parking_lot>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_parking_lot model;

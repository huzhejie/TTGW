...
namespace TTG.Web.TTGWeb.community_greening_problem
{
	...
	private void ShowInfo(string community_id,string community_fill_type,DateTime statistics_date)
	{
		...
		this.lblcommunity_road_wout_or_few_green_num.Text=model.community_road_wout_or_few_green_num.ToString();
		this.lblcommunity_road_wout_or_few_green_length.Text=model.community_road_wout_or_few_green_length.ToString();
		this.lblcommunity_bh_wout_or_few_green_res_num.Text=model.community_bh_wout_or_few_green_res_num.ToString();
		this.lblcommunity_bh_wout_or_few_green_unit_num.Text=model.community_bh_wout_or_few_green_unit_num.ToString();
		this.lblcommunity_green_wout_mta_num.Text=model.community_green_wout_mta_num.ToString();

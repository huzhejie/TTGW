<%@ Page Title="T_community_service_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_service_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_comp_mana_insuf_house" HeaderText="community_comp_mana_insuf_house" SortExpression="community_comp_mana_insuf_house" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_pension_faci" HeaderText="community_insuf_pension_faci" SortExpression="community_insuf_pension_faci" ItemStyle-HorizontalAlign="Center"  /> 

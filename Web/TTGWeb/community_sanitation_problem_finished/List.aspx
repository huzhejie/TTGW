<%@ Page Title="T_community_sanitation_problem_finished" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_sanitation_problem_finished.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_added_ashbin_num" HeaderText="community_added_ashbin_num" SortExpression="community_added_ashbin_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_dustbin_num" HeaderText="community_added_dustbin_num" SortExpression="community_added_dustbin_num" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="community_public_toilet_area" HeaderText="community_public_toilet_area" SortExpression="community_public_toilet_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_waste_transfer_station_num" HeaderText="community_added_waste_transfer_station_num" SortExpression="community_added_waste_transfer_station_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_waste_transfer_station_area" HeaderText="community_added_waste_transfer_station_area" SortExpression="community_added_waste_transfer_station_area" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_added_ashbin_dustbin_num" HeaderText="community_added_ashbin_dustbin_num" SortExpression="community_added_ashbin_dustbin_num" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="community_public_toilet_num_f_update" HeaderText="community_public_toilet_num_f_update" SortExpression="community_public_toilet_num_f_update" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_public_toilet_area_f_update" HeaderText="community_public_toilet_area_f_update" SortExpression="community_public_toilet_area_f_update" ItemStyle-HorizontalAlign="Center"  /> 

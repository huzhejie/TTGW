...
{
	/// <summary>
	/// 数据访问类:community_business_pop_problem
	/// </summary>
	public partial class community_business_pop_problem
	{
		public community_business_pop_problem()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("complete_year", "T_community_business_pop_problem"); 
		}
		...
		public bool Exists(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			...
			strSql.Append("select count(1) from T_community_business_pop_problem");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(TTG.Model.TTGWeb.community_business_pop_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_community_business_pop_problem(");
			strSql.Append("community_id,community_fill_type,community_block_bad,community_facade_upgrade,community_lack_prof_market,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,lock_tables,complete_year)");
			strSql.Append(" values (");
			strSql.Append("@community_id,@community_fill_type,@community_block_bad,@community_facade_upgrade,@community_lack_prof_market,@statistics_date,@check_status,@tciunset1,@tciunset2,@tciunset3,@tciunset4,@tciunset5,@tciunset6,@tciunset7,@lock_tables,@complete_year)");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
					new SqlParameter("@community_block_bad", SqlDbType.VarChar,20),
					new SqlParameter("@community_facade_upgrade", SqlDbType.VarChar,20),
					new SqlParameter("@community_lack_prof_market", SqlDbType.VarChar,20),
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
			...
			parameters[2].Value = model.community_block_bad;
			parameters[3].Value = model.community_facade_upgrade;
			parameters[4].Value = model.community_lack_prof_market;
			...
			parameters[15].Value = model.complete_year;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TTG.Model.TTGWeb.community_business_pop_problem model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_community_business_pop_problem set ");
			strSql.Append("community_block_bad=@community_block_bad,");
			strSql.Append("community_facade_upgrade=@community_facade_upgrade,");
			strSql.Append("community_lack_prof_market=@community_lack_prof_market,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@statistics_date", SqlDbType.DateTime),
					new SqlParameter("@complete_year", SqlDbType.Int,4)};
			parameters[0].Value = model.community_block_bad;
			parameters[1].Value = model.community_facade_upgrade;
			parameters[2].Value = model.community_lack_prof_market;
			...
			parameters[13].Value = model.community_fill_type;
		...
		public bool Delete(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_community_business_pop_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_business_pop_problem GetModel(string community_id,string community_fill_type,DateTime statistics_date,int complete_year)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 community_id,community_fill_type,community_block_bad,community_facade_upgrade,community_lack_prof_market,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,lock_tables,complete_year from T_community_business_pop_problem ");
			strSql.Append(" where community_id=@community_id and community_fill_type=@community_fill_type and statistics_date=@statistics_date and complete_year=@complete_year ");
			SqlParameter[] parameters = {
					new SqlParameter("@community_id", SqlDbType.VarChar,20),
					new SqlParameter("@community_fill_type", SqlDbType.VarChar,20),
		...
		/// 得到一个对象实体
		/// </summary>
		public TTG.Model.TTGWeb.community_business_pop_problem DataRowToModel(DataRow row)
		{
			TTG.Model.TTGWeb.community_business_pop_problem model=new TTG.Model.TTGWeb.community_business_pop_problem();
			if (row != null)
			{
				...
				if(row["community_block_bad"]!=null)
				{
					model.community_block_bad=row["community_block_bad"].ToString();
				}
				if(row["community_facade_upgrade"]!=null)
				{
					model.community_facade_upgrade=row["community_facade_upgrade"].ToString();
				}
				if(row["community_lack_prof_market"]!=null)
				{
					model.community_lack_prof_market=row["community_lack_prof_market"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select community_id,community_fill_type,community_block_bad,community_facade_upgrade,community_lack_prof_market,statistics_date,check_status,tciunset1,tciunset2,tciunset3,tciunset4,tciunset5,tciunset6,tciunset7,lock_tables,complete_year ");
			strSql.Append(" FROM T_community_business_pop_problem ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_community_business_pop_problem T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_community_business_pop_problem";

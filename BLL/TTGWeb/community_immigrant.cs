...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_immigrant dal=new TTG.DAL.TTGWeb.community_immigrant();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_immigrant GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_immigrantModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_immigrant)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_immigrant> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_immigrant> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_immigrant> modelList = new List<TTG.Model.TTGWeb.community_immigrant>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_immigrant model;

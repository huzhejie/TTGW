...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.community_service dal=new TTG.DAL.TTGWeb.community_service();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.community_service GetModelByCache(string community_id,DateTime statistics_date)
		{
			
			string CacheKey = "community_serviceModel-" + community_id+statistics_date;
			...
			return (TTG.Model.TTGWeb.community_service)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_service> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.community_service> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.community_service> modelList = new List<TTG.Model.TTGWeb.community_service>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.community_service model;

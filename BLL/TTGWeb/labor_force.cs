...
namespace TTG.BLL.TTGWeb
{
	...
	{
		private readonly TTG.DAL.TTGWeb.labor_force dal=new TTG.DAL.TTGWeb.labor_force();
		public labor_force()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTG.Model.TTGWeb.labor_force GetModelByCache(string id,DateTime statistics_date)
		{
			
			string CacheKey = "labor_forceModel-" + id+statistics_date;
			...
			return (TTG.Model.TTGWeb.labor_force)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.labor_force> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTG.Model.TTGWeb.labor_force> DataTableToList(DataTable dt)
		{
			List<TTG.Model.TTGWeb.labor_force> modelList = new List<TTG.Model.TTGWeb.labor_force>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTG.Model.TTGWeb.labor_force model;

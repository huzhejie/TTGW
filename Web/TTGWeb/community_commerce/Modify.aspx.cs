...
namespace TTG.Web.TTGWeb.community_commerce
{
	...
	private void ShowInfo(string community_id,DateTime statistics_date)
	{
		...
		this.txtcommunity_come_fac_num.Text=model.community_come_fac_num.ToString();
		this.txtcommunity_come_fac_fs.Text=model.community_come_fac_fs.ToString();
		this.txtcommunity_come_fac_gfa.Text=model.community_come_fac_gfa.ToString();
		this.txtcommunity_come_enp_num.Text=model.community_come_enp_num.ToString();
		this.txtcommunity_come_enp_fs.Text=model.community_come_enp_fs.ToString();
		this.txtcommunity_come_enp_gfa.Text=model.community_come_enp_gfa.ToString();
		this.txtcommunity_emporium_num.Text=model.community_emporium_num.ToString();
		this.txtcommunity_small_supermarket_num.Text=model.community_small_supermarket_num.ToString();
		this.txtcommunity_CVS_num.Text=model.community_CVS_num.ToString();
		this.txtcommunity_restauran_num.Text=model.community_restauran_num.ToString();
		this.txtcommunity_household_appliances_store_num.Text=model.community_household_appliances_store_num.ToString();
		this.txtcommunity_agricultural_production_num.Text=model.community_agricultural_production_num.ToString();
		this.txtcommunity_clothes_store_num.Text=model.community_clothes_store_num.ToString();
		this.txtcommunity_hardware_building_materials_store_num.Text=model.community_hardware_building_materials_store_num.ToString();
		this.txtcommunity_drugstore_num.Text=model.community_drugstore_num.ToString();
		this.txtcommunity_bookstore_num.Text=model.community_bookstore_num.ToString();
		this.txtcommunity_other_come_enp_num.Text=model.community_other_come_enp_num.ToString();
		this.txtcommunity_farm_produce_fair_num.Text=model.community_farm_produce_fair_num.ToString();
		this.txtcommunity_farm_produce_fair_gfa.Text=model.community_farm_produce_fair_gfa.ToString();
		this.txtcommunity_farm_produce_fair_fs.Text=model.community_farm_produce_fair_fs.ToString();
		this.txtcommunity_farm_produce_fair_dis_ots.Text=model.community_farm_produce_fair_dis_ots.ToString();
		this.txtcommunity_pedlar_market_num.Text=model.community_pedlar_market_num.ToString();
		this.txtcommunity_pedlar_market_gfa.Text=model.community_pedlar_market_gfa.ToString();
		this.txtcommunity_pedlar_market_fs.Text=model.community_pedlar_market_fs.ToString();
		this.txtcommunity_pedlar_market_dis_ots.Text=model.community_pedlar_market_dis_ots.ToString();
		this.txtcommunity_farm_whs_market_num.Text=model.community_farm_whs_market_num.ToString();
		this.txtcommunity_farm_whs_market_gfa.Text=model.community_farm_whs_market_gfa.ToString();
		this.txtcommunity_farm_whs_market_fs.Text=model.community_farm_whs_market_fs.ToString();
		this.txtcommunity_farm_whs_market_dis_ots.Text=model.community_farm_whs_market_dis_ots.ToString();
		this.lblstatistics_date.Text=model.statistics_date.ToString();
		this.txttccunset1.Text=model.tccunset1;
		this.txttccunset2.Text=model.tccunset2;
		this.txttccunset3.Text=model.tccunset3;
		this.txttccunset4.Text=model.tccunset4;
		this.txttccunset5.Text=model.tccunset5;
		this.txttccunset6.Text=model.tccunset6;
		this.txttccunset7.Text=model.tccunset7;
		this.txttccunset8.Text=model.tccunset8;
		this.txttccunset9.Text=model.tccunset9;
		this.txttccunset10.Text=model.tccunset10;
		this.txttccunset11.Text=model.tccunset11;
		this.txttccunset12.Text=model.tccunset12;
		this.txttccunset13.Text=model.tccunset13;
		this.txttccunset14.Text=model.tccunset14;
		this.txttccunset15.Text=model.tccunset15;
		this.txttccunset16.Text=model.tccunset16;
		this.txttccunset17.Text=model.tccunset17;
		this.txttccunset18.Text=model.tccunset18;
		this.txttccunset19.Text=model.tccunset19;
		this.txttccunset20.Text=model.tccunset20;
		this.txttccunset21.Text=model.tccunset21;
		this.txttccunset22.Text=model.tccunset22;
		this.txttccunset23.Text=model.tccunset23;
		this.txttccunset24.Text=model.tccunset24;
		this.txttccunset25.Text=model.tccunset25;
		this.txttccunset26.Text=model.tccunset26;
		this.txttccunset27.Text=model.tccunset27;
		this.txttccunset28.Text=model.tccunset28;
		this.txttccunset29.Text=model.tccunset29;

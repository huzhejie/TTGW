...
function showList(json) {
    ...
    choiceText1 += '<li class="toolItem city-item"><label>所有范围</label>';
   //choiceText1 += '<i class="icon-cater arrow"></i>';
    choiceText1 += '</li>';
    choiceText1 += '<li class="toolItem  tag-item  botn-line" ><label>所有地区</label>';
   //choiceText1 += '<i class="icon-cater arrow"></i>';
    choiceText1 += '</li>';

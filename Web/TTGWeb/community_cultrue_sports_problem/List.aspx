<%@ Page Title="T_community_cultrue_sports_problem" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="TTG.Web.TTGWeb.community_cultrue_sports_problem.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="community_outground_insuf_area_res_unit_num" HeaderText="community_outground_insuf_area_res_unit_num" SortExpression="community_outground_insuf_area_res_unit_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_outground_insuf_area_people_num" HeaderText="community_outground_insuf_area_people_num" SortExpression="community_outground_insuf_area_people_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_fite_res_unit_num" HeaderText="community_insuf_fite_res_unit_num" SortExpression="community_insuf_fite_res_unit_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_insuf_fite_people_num" HeaderText="community_insuf_fite_people_num" SortExpression="community_insuf_fite_people_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_ics_insuf_area_and_faci_res_unit_num" HeaderText="community_ics_insuf_area_and_faci_res_unit_num" SortExpression="community_ics_insuf_area_and_faci_res_unit_num" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="community_ics_insuf_area_and_faci_people_num" HeaderText="community_ics_insuf_area_and_faci_people_num" SortExpression="community_ics_insuf_area_and_faci_people_num" ItemStyle-HorizontalAlign="Center"  /> 
